...
const currencyStartDate = ref(LAST_7_DAYS[0]);
const currencyEndDate = ref(LAST_7_DAYS[1]);
...
const onCurrencyDateChange = () => {
  onCurrencyChange([currencyStartDate.value, currencyEndDate.value].filter(Boolean));
};
</script>
