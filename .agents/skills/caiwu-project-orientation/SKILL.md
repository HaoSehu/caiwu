...
description: Orient agents inside the Caiwu repository before project work. Use when starting tasks in C:\Users\Admin\Desktop\caiwu, choosing which app to edit, checking current directories, avoiding stale frontend names, updating docs, cleaning generated or legacy files, or deciding validation commands.
---
...
- For repo-local skill maintenance, use `.agents/` as the single local agent customization tree and keep edits scoped to that tree.
