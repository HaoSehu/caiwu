...
use App\Http\Controllers\Client\V2\ServiceBillingController;
use App\Http\Controllers\Client\V2\ServiceConsoleController;
use App\Http\Controllers\Client\V2\ServiceController;
use App\Http\Controllers\Client\V2\ServiceNetworkController;
...
Route::middleware(['auth:sanctum', 'ensure.client'])->group(function (): void {
    ...
    Route::get('/services/{id}/traffic-packages', [ServiceBillingController::class, 'trafficPackages']);
    Route::post('/services/{id}/traffic-packages/quote', [ServiceBillingController::class, 'quoteTrafficPackage'])->middleware('throttle:12,1,client-service-traffic-package-quote');
    Route::post('/services/{id}/traffic-packages/orders', [ServiceBillingController::class, 'createTrafficPackageOrder'])->middleware('throttle:6,1,client-service-traffic-package-order');
    Route::get('/services/{id}/upgrades', [ServiceBillingController::class, 'hostUpgradePreview']);
    Route::post('/services/{id}/upgrades/quotes', [ServiceBillingController::class, 'quoteHostUpgrade'])->middleware('throttle:12,1,client-service-host-upgrade-quote');
    Route::post('/services/{id}/upgrades/orders', [ServiceBillingController::class, 'createHostUpgradeOrder'])->middleware('throttle:6,1,client-service-host-upgrade-order');
    Route::get('/services/{id}/renewals', [ServiceBillingController::class, 'renewPreview']);
    Route::post('/services/{id}/renewals', [ServiceBillingController::class, 'createRenewOrder'])->middleware('throttle:6,1,client-service-renew');
    Route::put('/services/{id}/renewals/auto', [ServiceBillingController::class, 'updateAutoRenew'])->middleware('throttle:6,1,client-service-renew-auto');
    ...
    Route::get('/services/{id}/nat-forwardings', [ServiceNetworkController::class, 'natForwardings']);
    Route::post('/services/{id}/nat-forwardings', [ServiceNetworkController::class, 'createNatForwarding'])->middleware('throttle:10,1,client-service-nat-create');
    Route::delete('/services/{id}/nat-forwardings/{forwardingId}', [ServiceNetworkController::class, 'deleteNatForwarding'])->middleware('throttle:10,1,client-service-nat-delete');
    Route::get('/services/{id}/security-groups', [ServiceNetworkController::class, 'securityGroups']);
    Route::post('/services/{id}/security-groups', [ServiceNetworkController::class, 'createSecurityGroup'])->middleware('throttle:10,1,client-service-security-group-create');
    Route::get('/services/{id}/security-groups/{groupId}/rules', [ServiceNetworkController::class, 'securityGroupRules']);
    Route::post('/services/{id}/security-groups/{groupId}/apply', [ServiceNetworkController::class, 'applySecurityGroup'])->middleware('throttle:10,1,client-service-security-group-apply');
    Route::delete('/services/{id}/security-groups/{groupId}', [ServiceNetworkController::class, 'deleteSecurityGroup'])->middleware('throttle:10,1,client-service-security-group-delete');
    Route::post('/services/{id}/security-groups/{groupId}/rules', [ServiceNetworkController::class, 'createSecurityRule'])->middleware('throttle:10,1,client-service-security-rule-create');
    Route::delete('/services/{id}/security-groups/{groupId}/rules/{ruleId}', [ServiceNetworkController::class, 'deleteSecurityRule'])->middleware('throttle:10,1,client-service-security-rule-delete');
