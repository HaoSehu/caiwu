...
class PermissionCatalogService
{
    ...
    private function detectGroup(string $permission): string
    {
        return match ($permission) {
            ...
            AdminPermissions::ORDER_LIST, AdminPermissions::ORDER_DETAIL, AdminPermissions::ORDER_MANAGE, AdminPermissions::ORDER_MANUAL_ENTRY => 'finance_order',
            AdminPermissions::INVOICE_LIST, AdminPermissions::INVOICE_DETAIL, AdminPermissions::INVOICE_MANAGE, AdminPermissions::INVOICE_MANUAL_ENTRY => 'finance_invoice',
            ...
            AdminPermissions::REFERRAL_LIST, AdminPermissions::REFERRAL_WITHDRAWAL_LIST, AdminPermissions::MEMBER_LEVEL_LIST, AdminPermissions::MEMBER_LEVEL_MANAGE, AdminPermissions::PROMOTION_AMBASSADOR_LIST, AdminPermissions::PROMOTION_AMBASSADOR_MANAGE => 'marketing_growth',
    ...
    private function riskLevel(string $permission): string
    {
        ...
        return match ($permission) {
            ...
            AdminPermissions::ORDER_MANUAL_ENTRY,
            AdminPermissions::INVOICE_MANUAL_ENTRY,
    ...
    private function label(string $permission): string
    {
        return [
            ...
            AdminPermissions::PROMOTION_AMBASSADOR_LIST => '查看推广大使',
            AdminPermissions::PROMOTION_AMBASSADOR_MANAGE => '管理推广大使',
