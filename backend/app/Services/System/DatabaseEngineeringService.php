...
class DatabaseEngineeringService
{
    ...
    private function logicalForeignKeyTargets(): array
    {
        ...
        return [
            ...
            'product_groups.legacy_product_group_id' => $snapshot('旧库分组 ID 是迁移来源标识'),
            ...
            'second_product_groups.first_product_group_id' => $snapshot('兼容视图字段，由 product_groups.parent_id 投影，不单独声明外键'),
            ...
            'third_product_groups.second_product_group_id' => $snapshot('兼容视图字段，由 product_groups.parent_id 投影，不单独声明外键'),
