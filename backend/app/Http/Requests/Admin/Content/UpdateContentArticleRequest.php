...
class UpdateContentArticleRequest extends AdminFormRequest
{
    public function rules(): array
    {
        /** @var ContentArticle|null $article */
        ...
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:220',
                Rule::unique('content_articles', 'slug')
                    ->ignore($article?->id)
                    ->where(fn ($query) => $query->where('content_type', (string) ($this->input('content_type') ?: $this->input('type')))),
            ],
