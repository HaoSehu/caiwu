...
class MigrateContentSystemAutomationLogsCommand extends ContentSystemMigrateBaseCommand
{
    protected $signature = 'migrate:content-system:automation-logs
    ...
    protected $description = '迁移旧库 automation_logs 到 idc.automation_logs';
    ...
    {
        return 'content_system_automation_logs';
    }
    ...
    protected function migrateRows(array $commonColumns, int $batchSize): int
    {
        ...
        $payloads = $service->deriveAutomationLogPayloads();
