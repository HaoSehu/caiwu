...
class MigrateContentSystemNotificationLogsCommand extends ContentSystemMigrateBaseCommand
{
    protected $signature = 'migrate:content-system:notification-logs
    ...
    protected function migrateRows(array $commonColumns, int $batchSize): int
    {
        ...
        $payloads = $service->deriveNotificationLogPayloads();
