...
class MigrateContentSystemTicketRepliesCommand extends ContentSystemMigrateBaseCommand
{
    protected $signature = 'migrate:content-system:ticket-replies
    ...
    protected $description = '迁移旧库 ticket_replies 到 idc.ticket_replies';
    ...
    {
        return 'content_system_ticket_replies';
    }
    ...
    protected function migrateRows(array $commonColumns, int $batchSize): int
    {
        ...
        $payloads = $service->deriveTicketReplyPayloads();
