...
final class MofangInventoryAndServiceSyncTask implements ScheduledTask
{
    public const KEY = 'sync-mofang-finance-inventory-and-services';

    public const HOOK = 'plugins.mofang_finance.inventory_service_sync';
    ...
    {
        return '由魔方财务插件每 15 分钟拉取一次商品库存，并同步已购买服务的状态、连接和运行快照。';
    }
