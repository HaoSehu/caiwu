...
**请求方法**：DELETE  
**请求路径**：`/api/admin/product-categories/{productCategory}`  
**调试状态**：⬜ 待调试
...
| effective_product_group_level | integer | 是 | 请求体参数；校验规则：required\|integer\|in:"1","2","3"；来源：DestroyRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\ProductCategoryController@destroy`  
