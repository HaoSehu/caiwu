...
**请求方法**：GET  
**请求路径**：`/api/admin/suppliers/{supplier}/products`  
**调试状态**：⬜ 待调试
...
| data.groups | array | 业务字段；由源码静态提取 |
| data.products | array | 业务字段；由源码静态提取 |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\SupplierController@products`  
