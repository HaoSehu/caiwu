...
**请求方法**：PUT  
**请求路径**：`/api/admin/users/{user}/services/{serviceId}/manual-provision`  
**调试状态**：⬜ 待调试
...
| remark | string | 否 | 请求体参数；校验规则：nullable\|string\|max:200；来源：ManualProvisionUserServiceRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\UserController@manualProvisionService`  
