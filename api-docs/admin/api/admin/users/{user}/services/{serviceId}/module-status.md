...
**请求方法**：GET  
**请求路径**：`/api/admin/users/{user}/services/{serviceId}/module-status`  
**调试状态**：⬜ 待调试
...
| type | string | 是 | 查询参数；校验规则：required\|string\|in:host,reinstall,repassword；来源：ServiceModuleStatusRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\UserController@serviceModuleStatus`  
