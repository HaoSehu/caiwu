...
**请求方法**：PUT  
**请求路径**：`/api/admin/users/{user}/services/{serviceId}/reinstall`  
**调试状态**：⬜ 待调试
...
| os_id | string | 是 | 请求体参数；校验规则：required\|string\|max:50；来源：ServiceReinstallRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\UserController@serviceReinstall`  
