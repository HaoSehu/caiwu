...
```json
{
    ...
    "data": {
        ...
        "first_page_url": "http://127.0.0.1:8000/api/admin/logs/activity?page=1",
        "from": 1,
        "last_page": 206,
        "last_page_url": "http://127.0.0.1:8000/api/admin/logs/activity?page=206",
        "links": [
            {
                "url": null,
            ...
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=1",
                "label": "1",
                "page": 1,
                "active": true
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=2",
                "label": "2",
                "page": 2,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=3",
                "label": "3",
                "page": 3,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=4",
                "label": "4",
                "page": 4,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=5",
                "label": "5",
                "page": 5,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=6",
                "label": "6",
                "page": 6,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=7",
                "label": "7",
                "page": 7,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=8",
                "label": "8",
                "page": 8,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=9",
                "label": "9",
                "page": 9,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=10",
                "label": "10",
                "page": 10,
                "active": false
            },
            ...
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=205",
                "label": "205",
                "page": 205,
                "active": false
            },
            {
                "url": "http://127.0.0.1:8000/api/admin/logs/activity?page=206",
                "label": "206",
                "page": 206,
                "active": false
            },
        ...
        "next_page_url": "http://127.0.0.1:8000/api/admin/logs/activity?page=2",
        "path": "http://127.0.0.1:8000/api/admin/logs/activity",
        "per_page": 20,
        "prev_page_url": null,
        "to": 20,
        "total": 4118,
...
· 响应状态码：200  
· 调用方式：GET /api/admin/logs/activity  
· 验证方式：真实调用；接口被判定为无破坏性或仅影响本轮临时 token  
· 脱敏说明：token、password、secret、key、authorization 等敏感字段已脱敏

### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\LogController@activityLogs`  
