...
**请求方法**：POST  
**请求路径**：`/api/admin/coupon-campaigns/{couponCampaign}/trigger`  
**调试状态**：⬜ 待调试
...
| data.campaign | string | 业务字段；由源码静态提取 |
| data.coupon | object | 业务字段；由源码静态提取 |
| data.triggered_at | string(datetime) | 业务字段；由源码静态提取 |
...
```json
{
    ...
    "data": {
        "campaign": "string",
        "coupon": [],
        "triggered_at": "2026-07-05 12:00:00"
    },
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\CouponCampaignController@trigger`  
