...
**请求方法**：POST  
**请求路径**：`/api/admin/tickets/{ticket}/assign`  
**调试状态**：⬜ 待调试
...
| assignee_id | integer | 是 | 请求体参数；校验规则：required\|integer\|exists:admin_users,id；来源：AssignRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Admin\TicketController@assign`  
