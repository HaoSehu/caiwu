...
**请求方法**：GET  
**请求路径**：`/api/client/services/{id}/module-status`  
**调试状态**：⬜ 待调试
...
| type | string | 是 | 查询参数；校验规则：required\|string\|in:host,reinstall,repassword；来源：ModuleStatusRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Client\ServiceController@moduleStatus`  
