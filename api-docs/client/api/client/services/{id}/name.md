...
**请求方法**：PUT  
**请求路径**：`/api/client/services/{id}/name`  
**调试状态**：⬜ 待调试
...
| name | string | 否 | 请求体参数；校验规则：nullable\|string\|max:120；来源：UpdateNameRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Client\ServiceController@updateName`  
