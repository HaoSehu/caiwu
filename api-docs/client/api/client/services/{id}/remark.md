...
**请求方法**：PUT  
**请求路径**：`/api/client/services/{id}/remark`  
**调试状态**：⬜ 待调试
...
| remark | string | 否 | 请求体参数；校验规则：nullable\|string\|max:120；来源：UpdateRemarkRequest |
...
### 源码依据
· 控制器动作：`App\Http\Controllers\Client\ServiceController@updateRemark`  
