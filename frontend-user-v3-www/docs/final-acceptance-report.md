...
公开官网路由已从旧 `frontend-client` 拆分到 `frontend-user-v3-www`，构建后生成 sitemap、robots 和静态公开路由 HTML。
...
| 公开路由 | 已迁移 | 仅包含官网和公开内容 |
| `/client/*` | 不承载 | 控制台路由迁移到 `frontend-user-v3-console` |
...
| 控制台外链 | 通过 | 登录、注册、下单续接统一指向 `https://console.coyjs.cn/client/*` |
