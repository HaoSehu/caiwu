...
const paymentButtonText = computed(() => rechargePaid.value ? '继续充值' : paymentPayload.value ? '刷新支付宝二维码' : '生成支付宝二维码')
...
.qrcode-frame {
  ...
  &.is-paid {
    border-color: rgba(43, 183, 116, 0.44);
    background: linear-gradient(180deg, #ffffff, #f2fff8);
    box-shadow: 0 18px 36px rgba(43, 183, 116, 0.18);
    ...
    &::before {
      ...
      inset: 28px;
      border-radius: 999px;
      background: rgba(43, 183, 116, 0.12);
      animation: success-halo 900ms cubic-bezier(0.22, 1, 0.36, 1) both;
    }
  }
...
.success-icon {
  ...
  &::after {
    ...
    animation: success-ring 900ms cubic-bezier(0.22, 1, 0.36, 1) both;
  }
}
