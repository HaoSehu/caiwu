      ...
      <div class="console-content">
        ...
        <template v-else-if="activeTab === 'nat'">
          <ServiceConsoleNat
            ...
            :nat-form="natForm"
            :nat-rules="natRules"
            @refresh="loadNatForwardings"
            @submit="submitNatForwarding"
            @delete="handleDeleteNatForwarding"
          />
        </template>
...
import { ArrowRight, Connection, Document, Grid, Lock, Monitor, RefreshRight, SwitchButton, TrendCharts } from '@element-plus/icons-vue'
...
import ServiceConsoleNat from '../components/ServiceConsoleNat.vue'
...
const props = defineProps({
  ...
  availableTabs: { type: Array, default: () => ['overview', 'monitor', 'security', 'nat', 'power', 'logs', 'vnc'] },
})
...
const consoleNavItems = computed(() => [
  ...
  { key: 'nat', label: '端口转发', icon: Connection },
