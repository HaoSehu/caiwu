...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `account_transactions` | BASE TABLE | InnoDB | 734 | 160 KB | 208 KB | 1,744 | utf8mb4_unicode_ci | 账户流水表，记录现金账户、授信账户、推荐奖励账户的每一次余额变化 |
| `activity_logs` | BASE TABLE | InnoDB | 13,790 | 10.52 MB | 2.5 MB | 22,798 | utf8mb4_unicode_ci | — |
| `admin_user_roles` | BASE TABLE | InnoDB | 12 | 16 KB | 32 KB | 164 | utf8mb4_unicode_ci | — |
| `admin_users` | BASE TABLE | InnoDB | 305 | 80 KB | 48 KB | 313 | utf8mb4_unicode_ci | — |
| `agent_applications` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | 1 | utf8mb4_unicode_ci | — |
| `archive_audit_logs` | BASE TABLE | InnoDB | 1 | 16 KB | 32 KB | 2 | utf8mb4_unicode_ci | — |
| `automation_logs` | BASE TABLE | InnoDB | 1,041 | 224 KB | 224 KB | 1,254 | utf8mb4_unicode_ci | — |
| `content_articles` | BASE TABLE | InnoDB | 14 | 80 KB | 160 KB | 35 | utf8mb4_unicode_ci | — |
| `content_categories` | BASE TABLE | InnoDB | 4 | 16 KB | 48 KB | 11 | utf8mb4_unicode_ci | — |
| `coupon_campaigns` | BASE TABLE | InnoDB | 13 | 16 KB | 48 KB | 15 | utf8mb4_unicode_ci | — |
| `coupons` | BASE TABLE | InnoDB | 86 | 16 KB | 48 KB | 92 | utf8mb4_unicode_ci | — |
| `failed_jobs` | BASE TABLE | InnoDB | 33 | 1.52 MB | 16 KB | 50 | utf8mb4_unicode_ci | — |
| `first_product_groups` | BASE TABLE | InnoDB | 16 | 16 KB | 32 KB | 17 | utf8mb4_unicode_ci | — |
| `gateway_logs` | BASE TABLE | InnoDB | 66 | 48 KB | 112 KB | 67 | utf8mb4_unicode_ci | — |
| `integration_plugin_bindings` | BASE TABLE | InnoDB | 0 | 16 KB | 80 KB | 1 | utf8mb4_unicode_ci | — |
| `integration_plugin_configs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 1 | utf8mb4_unicode_ci | — |
| `integration_plugin_runtime_logs` | BASE TABLE | InnoDB | 7,956 | 9.52 MB | 1.5 MB | 8,632 | utf8mb4_unicode_ci | — |
| `integration_plugins` | BASE TABLE | InnoDB | 1 | 16 KB | 48 KB | 5 | utf8mb4_unicode_ci | — |
| `invoice_items` | BASE TABLE | InnoDB | 2,831 | 512 KB | 80 KB | 2,774 | utf8mb4_unicode_ci | 账单明细表，记录账单内每个收费项目和快照信息 |
| `invoices` | BASE TABLE | InnoDB | 3,076 | 1.52 MB | 1.08 MB | 2,992 | utf8mb4_unicode_ci | 账单主表，所有购买、续费、充值、扣款和退款流程以账单为财务入口 |
| `jobs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 1,071 | utf8mb4_unicode_ci | — |
| `media_files` | BASE TABLE | InnoDB | 18 | 16 KB | 48 KB | 62 | utf8mb4_unicode_ci | — |
| `member_levels` | BASE TABLE | InnoDB | 5 | 16 KB | 48 KB | 9 | utf8mb4_unicode_ci | — |
| `message_logs` | BASE TABLE | InnoDB | 1,839 | 13.52 MB | 656 KB | 2,527 | utf8mb4_unicode_ci | — |
| `migrations` | BASE TABLE | InnoDB | 171 | 16 KB | 0 B | 176 | utf8mb4_unicode_ci | — |
| `notice_reads` | BASE TABLE | InnoDB | 108 | 16 KB | 48 KB | 142 | utf8mb4_unicode_ci | — |
| `notification_templates` | BASE TABLE | InnoDB | 56 | 256 KB | 32 KB | 981 | utf8mb4_unicode_ci | — |
| `operation_logs` | BASE TABLE | InnoDB | 135,432 | 65.59 MB | 26.09 MB | 154,358 | utf8mb4_unicode_ci | — |
| `orders` | BASE TABLE | InnoDB | 395 | 336 KB | 176 KB | 3,080 | utf8mb4_unicode_ci | — |
| `password_reset_tokens` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | — | utf8mb4_unicode_ci | — |
| `payment_callbacks` | BASE TABLE | InnoDB | 356 | 288 KB | 96 KB | 488 | utf8mb4_unicode_ci | 支付回调审计表，保存第三方通知、查询、退款等回调验签结果 |
| `payments` | BASE TABLE | InnoDB | 361 | 304 KB | 160 KB | 364 | utf8mb4_unicode_ci | 第三方支付记录表，仅记录真实外部资金流入和退款状态，不记录余额/免费/手工开服 |
| `personal_access_tokens` | BASE TABLE | InnoDB | 110 | 48 KB | 48 KB | 126 | utf8mb4_unicode_ci | — |
| `product_upstream_bindings` | BASE TABLE | InnoDB | 229 | 12.52 MB | 96 KB | 268 | utf8mb4_unicode_ci | — |
| `products` | BASE TABLE | InnoDB | 260 | 9.52 MB | 48 KB | 379 | utf8mb4_unicode_ci | 商品表，记录可售卖产品的分类、定价、库存、上游绑定和开通策略 |
...
| `referral_rewards` | BASE TABLE | InnoDB | 9 | 16 KB | 96 KB | 11 | utf8mb4_unicode_ci | — |
| `referral_withdrawals` | BASE TABLE | InnoDB | 3 | 16 KB | 48 KB | 4 | utf8mb4_unicode_ci | — |
| `refunds` | BASE TABLE | InnoDB | 0 | 16 KB | 96 KB | 1 | utf8mb4_unicode_ci | — |
| `roles` | BASE TABLE | InnoDB | 299 | 64 KB | 16 KB | 397 | utf8mb4_unicode_ci | — |
| `schedule_run_logs` | BASE TABLE | InnoDB | 146,452 | 35.56 MB | 20.06 MB | 148,680 | utf8mb4_unicode_ci | — |
| `schedule_task_runs` | BASE TABLE | InnoDB | 876 | 320 KB | 240 KB | 965 | utf8mb4_unicode_ci | — |
| `schedule_ticks` | BASE TABLE | InnoDB | 73 | 16 KB | 48 KB | 83 | utf8mb4_unicode_ci | — |
| `second_product_groups` | BASE TABLE | InnoDB | 16 | 16 KB | 32 KB | 17 | utf8mb4_unicode_ci | — |
| `service_connection_snapshots` | BASE TABLE | InnoDB | 175 | 256 KB | 80 KB | 193 | utf8mb4_unicode_ci | — |
| `service_provision_attempts` | BASE TABLE | InnoDB | 216 | 80 KB | 80 KB | 420 | utf8mb4_unicode_ci | — |
| `service_runtime_snapshots` | BASE TABLE | InnoDB | 175 | 224 KB | 80 KB | 193 | utf8mb4_unicode_ci | — |
| `service_upstream_bindings` | BASE TABLE | InnoDB | 247 | 192 KB | 112 KB | 277 | utf8mb4_unicode_ci | — |
| `services` | BASE TABLE | InnoDB | 180 | 1.52 MB | 128 KB | 300 | utf8mb4_unicode_ci | 服务实例表，记录用户已购买产品的生命周期、计费、上游和续费状态 |
| `sessions` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | — | utf8mb4_unicode_ci | — |
| `settings` | BASE TABLE | InnoDB | 111 | 16 KB | 16 KB | 343 | utf8mb4_unicode_ci | — |
| `supplier_plugin_bindings` | BASE TABLE | InnoDB | 60 | 48 KB | 64 KB | 102 | utf8mb4_unicode_ci | — |
| `suppliers` | BASE TABLE | InnoDB | 82 | 16 KB | 32 KB | 91 | utf8mb4_unicode_ci | — |
| `third_product_groups` | BASE TABLE | InnoDB | 24 | 16 KB | 32 KB | 25 | utf8mb4_unicode_ci | — |
| `ticket_replies` | BASE TABLE | InnoDB | 167 | 48 KB | 32 KB | 168 | utf8mb4_unicode_ci | — |
| `tickets` | BASE TABLE | InnoDB | 72 | 16 KB | 96 KB | 73 | utf8mb4_unicode_ci | — |
| `user_accounts` | BASE TABLE | InnoDB | 489 | 64 KB | 0 B | — | utf8mb4_unicode_ci | 用户账户余额源表，集中承载现金余额、授信和推荐奖励余额 |
| `user_coupons` | BASE TABLE | InnoDB | 81 | 16 KB | 64 KB | 90 | utf8mb4_unicode_ci | — |
| `user_notifications` | BASE TABLE | InnoDB | 95 | 48 KB | 48 KB | 96 | utf8mb4_unicode_ci | — |
| `users` | BASE TABLE | InnoDB | 876 | 192 KB | 288 KB | 988,048 | utf8mb4_unicode_ci | — |
| `verification_histories` | BASE TABLE | InnoDB | 90 | 16 KB | 48 KB | 96 | utf8mb4_unicode_ci | — |
...
| 8 | `source_type` | `varchar(30)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 业务来源类型，如 invoice/payment/referral_withdrawal |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `account_transactions_created_at_idx` | 否 | `BTREE` | `created_at` | 634 | — |
| `account_transactions_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 645 | — |
| `account_transactions_trace_id_idx` | 否 | `BTREE` | `trace_id` | 568 | — |
| `account_transactions_user_account_created_idx` | 否 | `BTREE` | `user_id`, `account_type`, `created_at`, `id` | 648 | — |
| `account_transactions_user_event_created_idx` | 否 | `BTREE` | `user_id`, `event_type`, `created_at` | 641 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 648 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `activity_logs_actor_id_index` | 否 | `BTREE` | `actor_id` | 34 | — |
| `activity_logs_created_at_index` | 否 | `BTREE` | `created_at` | 8,250 | — |
| `activity_logs_module_action_index` | 否 | `BTREE` | `module`, `action` | 709 | — |
| `activity_logs_subject_type_subject_id_index` | 否 | `BTREE` | `subject_type`, `subject_id` | 122 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 22,829 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `archive_batch_idx` | 否 | `BTREE` | `batch_id` | 1 | — |
| `archive_table_status_idx` | 否 | `BTREE` | `table_name`, `status`, `created_at` | 1 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `automation_logs_object_idx` | 否 | `BTREE` | `object_type`, `object_id` | 364 | — |
| `automation_logs_task_key_index` | 否 | `BTREE` | `task_key` | 6 | — |
| `automation_logs_unique_rule` | 是 | `BTREE` | `task_key`, `action`, `object_type`, `object_id`, `rule_key` | 719 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 719 | — |
...
| 11 | `status` | `tinyint` | 否 | `0` | MUL | — | — | — | 0=草稿 1=已发布 2=已下线 |
...
| `idx_article_published` | 否 | `BTREE` | `status`, `publish_at`, `is_pinned` | 14 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `failed_jobs_uuid_unique` | 是 | `BTREE` | `uuid` | 40 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 40 | — |
...
| 9 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序 |
| 10 | `is_visible` | `tinyint unsigned` | 否 | `1` | — | — | — | — | 前台可见 |
| 11 | `is_system` | `tinyint unsigned` | 否 | `0` | — | — | — | — | 系统内置 |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `gateway_logs_created_at_index` | 否 | `BTREE` | `created_at` | 72 | — |
| `gateway_logs_gateway_action_index` | 否 | `BTREE` | `gateway`, `action` | 2 | — |
| `gateway_logs_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `created_at` | 72 | — |
| `gateway_logs_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 1 | — |
| `gateway_logs_out_trade_no_index` | 否 | `BTREE` | `out_trade_no` | 68 | — |
| `gateway_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 72 | — |
| `gateway_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 19 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 72 | — |
...
| `plugin_bindings_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `domain` | 8 | — |
| `plugin_bindings_domain_provider_status_idx` | 否 | `BTREE` | `domain`, `provider_key`, `status` | 5 | — |
| `plugin_bindings_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 5 | — |
| `plugin_bindings_unique` | 是 | `BTREE` | `domain`, `binding_type`, `bindable_type`, `bindable_id`, `binding_key` | 9 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `plugin_runtime_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `created_at` | 7,255 | — |
| `plugin_runtime_domain_action_created_idx` | 否 | `BTREE` | `domain`, `action`, `created_at` | 9,557 | — |
| `plugin_runtime_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 7,375 | — |
| `plugin_runtime_status_created_idx` | 否 | `BTREE` | `status`, `created_at` | 7,281 | — |
| `plugin_runtime_trace_idx` | 否 | `BTREE` | `trace_id` | 11,970 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 11,970 | — |
...
| 7 | `provider_class` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 8 | `entry_class` | `varchar(255)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 9 | `capabilities_json` | `json` | 是 | `NULL` | — | — | — | — | — |
| 10 | `config_schema_json` | `json` | 是 | `NULL` | — | — | — | — | — |
| 11 | `status` | `tinyint unsigned` | 否 | `0` | — | — | — | — | — |
| 12 | `installed_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 13 | `enabled_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 14 | `disabled_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 15 | `installed_by` | `bigint unsigned` | 是 | `NULL` | — | — | — | — | — |
| 16 | `enabled_by` | `bigint unsigned` | 是 | `NULL` | — | — | — | — | — |
| 17 | `source_hash` | `varchar(128)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 18 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 19 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `integration_plugins_domain_key_unique` | 是 | `BTREE` | `domain`, `plugin_key` | 13 | — |
| `integration_plugins_domain_slug_unique` | 是 | `BTREE` | `domain`, `slug` | 13 | — |
| `integration_plugins_domain_status_index` | 否 | `BTREE` | `domain`, `status` | 12 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `invoice_items_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 2,748 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,748 | — |
...
| 23 | `status` | `tinyint` | 否 | `0` | MUL | — | — | — | 账单状态：0待支付 1已支付 2已取消 3已逾期 5已退款 |
...
| `invoices_invoice_no_unique` | 是 | `BTREE` | `invoice_no` | 2,782 | — |
| `invoices_order_id_idx` | 否 | `BTREE` | `order_id` | 292 | — |
| `invoices_origin_invoice_id_foreign` | 否 | `BTREE` | `origin_invoice_id` | 1 | — |
| `invoices_product_id_idx` | 否 | `BTREE` | `product_id` | 55 | — |
| `invoices_service_id_idx` | 否 | `BTREE` | `service_id` | 134 | — |
| `invoices_status_due_date_index` | 否 | `BTREE` | `status`, `due_date` | 730 | — |
| `invoices_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 951 | — |
| `invoices_trace_id_idx` | 否 | `BTREE` | `trace_id` | 2,160 | — |
| `invoices_user_id_index` | 否 | `BTREE` | `user_id` | 317 | — |
| `invoices_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 2,644 | — |
| `invoices_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 2,782 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,817 | — |
...
| `media_files_group_index` | 否 | `BTREE` | `group` | 3 | — |
| `media_files_uploaded_by_index` | 否 | `BTREE` | `uploaded_by` | 1 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 18 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `message_logs_channel_created_at_idx` | 否 | `BTREE` | `channel`, `created_at` | 1,401 | — |
| `message_logs_channel_driver_idx` | 否 | `BTREE` | `channel`, `driver_key`, `created_at` | 1,401 | — |
| `message_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 1,401 | — |
| `message_logs_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 268 | — |
| `message_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 1,401 | — |
| `message_logs_recipient_created_at_idx` | 否 | `BTREE` | `recipient`, `created_at` | 1,401 | — |
| `message_logs_request_id_idx` | 否 | `BTREE` | `request_id` | 14 | — |
| `message_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 1,401 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 1,401 | — |
...
| `notice_reads_user_id_article_id_unique` | 是 | `BTREE` | `user_id`, `article_id` | 125 | — |
| `notice_reads_user_id_index` | 否 | `BTREE` | `user_id` | 24 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 125 | — |
...
| `notification_templates_channel_code_unique` | 是 | `BTREE` | `channel`, `code` | 37 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `operation_logs_created_at_idx` | 否 | `BTREE` | `created_at` | 80,119 | — |
| `operation_logs_module_created_at_index` | 否 | `BTREE` | `module`, `created_at` | 104,115 | — |
| `operation_logs_module_subject_created_idx` | 否 | `BTREE` | `module`, `subject_id`, `created_at`, `id` | 160,420 | — |
| `operation_logs_user_created_at_idx` | 否 | `BTREE` | `user_id`, `created_at` | 82,274 | — |
| `operation_logs_user_id_user_type_index` | 否 | `BTREE` | `user_id`, `user_type` | 164 | — |
| `operation_logs_user_type_created_at_idx` | 否 | `BTREE` | `user_id`, `user_type`, `created_at` | 98,021 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 160,420 | — |
...
| `orders_created_at_idx` | 否 | `BTREE` | `created_at` | 278 | — |
| `orders_order_no_unique` | 是 | `BTREE` | `order_no` | 289 | — |
| `orders_product_id_idx` | 否 | `BTREE` | `product_id` | 53 | — |
| `orders_projection_type_idx` | 否 | `BTREE` | `projection_type` | 1 | — |
| `orders_service_status_id_idx` | 否 | `BTREE` | `service_id`, `status`, `id` | 289 | — |
| `orders_status_type_created_at_idx` | 否 | `BTREE` | `status`, `type`, `created_at`, `id` | 289 | — |
| `orders_trace_id_idx` | 否 | `BTREE` | `trace_id` | 121 | — |
| `orders_user_coupon_id_idx` | 否 | `BTREE` | `user_coupon_id` | 3 | — |
| `orders_user_id_index` | 否 | `BTREE` | `user_id` | 102 | — |
| `orders_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 289 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 289 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payment_callbacks_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `received_at` | 302 | — |
| `payment_callbacks_gateway_trade_no_idx` | 否 | `BTREE` | `gateway_trade_no` | 202 | — |
| `payment_callbacks_payment_type_unique` | 是 | `BTREE` | `payment_id`, `callback_type` | 312 | — |
| `payment_callbacks_plugin_received_idx` | 否 | `BTREE` | `plugin_id`, `received_at` | 302 | — |
| `payment_callbacks_trace_id_idx` | 否 | `BTREE` | `trace_id` | 110 | — |
| `payment_callbacks_verified_received_idx` | 否 | `BTREE` | `is_verified`, `received_at` | 311 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 312 | — |
...
| 11 | `status` | `tinyint` | 否 | `0` | MUL | — | — | — | 支付状态：0待支付 1成功 2失败 3已退款 |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payments_invoice_gateway_status_id_idx` | 否 | `BTREE` | `invoice_id`, `status`, `id` | 303 | — |
| `payments_invoice_status_created_at_idx` | 否 | `BTREE` | `invoice_id`, `status`, `created_at`, `id` | 303 | — |
| `payments_order_status_idx` | 否 | `BTREE` | `order_id`, `status` | 168 | — |
| `payments_payment_no_unique` | 是 | `BTREE` | `payment_no` | 303 | — |
| `payments_plugin_status_paid_idx` | 否 | `BTREE` | `plugin_id`, `status`, `paid_at` | 252 | — |
| `payments_plugin_trade_unique` | 是 | `BTREE` | `plugin_id`, `gateway_key`, `trade_no` | 203 | — |
| `payments_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 251 | — |
| `payments_trace_id_idx` | 否 | `BTREE` | `trace_id` | 113 | — |
| `payments_trade_no_index` | 否 | `BTREE` | `trade_no` | 202 | — |
| `payments_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 303 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 303 | — |
...
| `personal_access_tokens_token_unique` | 是 | `BTREE` | `token` | 37 | — |
...
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 0 | — |
| `product_upstream_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 0 | — |
| `product_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 0 | — |
| `product_upstream_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 0 | — |
| `product_upstream_product_status_idx` | 否 | `BTREE` | `product_id`, `status` | 0 | — |
| `product_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status` | 0 | — |
| `product_upstream_unique` | 是 | `BTREE` | `product_id`, `supplier_plugin_binding_id`, `upstream_product_id` | 0 | — |
...
| 5 | `custom_display_name` | `varchar(190)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 自定义展示名称 |
| 6 | `remark` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 商品备注 |
| 7 | `pricing` | `json` | 否 | — | — | — | — | — | 周期价格 JSON，如 monthly/quarterly/annually |
| 8 | `setup_fee` | `decimal(12,2)` | 否 | `0.00` | — | — | — | — | 初装费 |
| 9 | `config_options` | `json` | 是 | `NULL` | — | — | — | — | 可选配置项 JSON |
| 10 | `purchase_requires` | `json` | 是 | `NULL` | — | — | — | — | 购买限制 JSON，如实名认证、手机号要求 |
| 11 | `stock` | `int` | 否 | `-1` | — | — | — | — | 库存数量，-1 表示不限 |
| 12 | `status` | `tinyint` | 否 | `1` | MUL | — | — | — | 商品状态：0下架 1上架 |
| 13 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序值，越小越靠前 |
| 14 | `auto_setup` | `tinyint` | 否 | `0` | — | — | — | — | 是否自动开通：0手动 1自动 |
| 15 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 创建时间 |
| 16 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 更新时间 |
| 17 | `deleted_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 软删除时间 |

#### 索引

| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_product_status_groups` | 否 | `BTREE` | `status` | 2 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 140 | — |
| `products_group_status_sort_id_idx` | 否 | `BTREE` | `product_group_id`, `status`, `sort_order`, `id` | 140 | — |
...
| 10 | `scene` | `varchar(30)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 11 | `direction` | `varchar(8)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 12 | `amount` | `decimal(12,2)` | 否 | — | — | — | — | — | — |
| 13 | `currency` | `varchar(3)` | 否 | `CNY` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 14 | `entry_type` | `varchar(30)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
...
| 10 | `trace_id` | `varchar(64)` | 否 | — | UNI | — | utf8mb4 | utf8mb4_unicode_ci | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 149,100 | — |
| `schedule_run_logs_created_at_index` | 否 | `BTREE` | `created_at` | 78,961 | — |
| `schedule_run_logs_status_index` | 否 | `BTREE` | `status` | 1 | — |
| `schedule_run_logs_task_name_created_at_index` | 否 | `BTREE` | `task_name`, `created_at` | 143,553 | — |
| `schedule_run_logs_task_name_index` | 否 | `BTREE` | `task_name` | 18 | — |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | — | PRI | auto_increment | — | — | — |
| 2 | `schedule_tick_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | — |
| 3 | `task_key` | `varchar(120)` | 否 | — | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 4 | `task_name` | `varchar(160)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 5 | `rule_description` | `varchar(160)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 6 | `source` | `varchar(40)` | 否 | `heartbeat` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 7 | `queue` | `varchar(80)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 8 | `status` | `varchar(30)` | 否 | `queued` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 9 | `duration_ms` | `int unsigned` | 是 | `NULL` | — | — | — | — | — |
| 10 | `summary` | `json` | 是 | `NULL` | — | — | — | — | — |
| 11 | `error_msg` | `text` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 12 | `queued_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 13 | `started_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 14 | `finished_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 15 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 16 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 3,240 | — |
| `schedule_task_runs_active_lookup_index` | 否 | `BTREE` | `task_key`, `status`, `queued_at` | 3,240 | — |
| `schedule_task_runs_source_created_at_index` | 否 | `BTREE` | `source`, `created_at` | 301 | — |
| `schedule_task_runs_status_created_at_index` | 否 | `BTREE` | `status`, `created_at` | 358 | — |
| `schedule_task_runs_task_key_created_at_index` | 否 | `BTREE` | `task_key`, `created_at` | 3,240 | — |
| `schedule_task_runs_tick_task_source_unique` | 是 | `BTREE` | `schedule_tick_id`, `task_key`, `source` | 3,240 | — |

#### 外键约束

| 约束名 | 字段 | 引用表 | 引用字段 | 更新规则 | 删除规则 |
| --- | --- | --- | --- | --- | --- |
| `schedule_task_runs_schedule_tick_id_foreign` | `schedule_tick_id` | `schedule_ticks` | `id` | `NO ACTION` | `CASCADE` |
...
| 5 | `triggered_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | — | PRI | auto_increment | — | — | — |
| 2 | `first_product_group_id` | `bigint unsigned` | 否 | — | MUL | — | — | — | → first_product_groups.id |
...
| 7 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序 |
| 8 | `is_visible` | `tinyint unsigned` | 否 | `1` | — | — | — | — | 前台可见 |
| 9 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 10 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| `PRIMARY` | 是 | `BTREE` | `id` | 16 | — |
| `uq_second_first_slug` | 是 | `BTREE` | `first_product_group_id`, `slug` | 16 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 164 | — |
| `service_connection_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `service_connection_plugin_checked_idx` | 否 | `BTREE` | `plugin_id`, `checked_at` | 112 | — |
| `service_connection_provider_type_idx` | 否 | `BTREE` | `provider_key`, `connection_type` | 2 | — |
| `service_connection_service_type_unique` | 是 | `BTREE` | `service_id`, `connection_type` | 164 | — |
| `service_connection_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 2 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 222 | — |
| `service_attempt_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `service_attempt_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `attempt_status`, `attempted_at` | 176 | — |
| `service_attempt_service_action_idx` | 否 | `BTREE` | `service_id`, `action`, `attempted_at` | 222 | — |
| `service_attempt_trace_idx` | 否 | `BTREE` | `trace_id` | 84 | — |
...
| `service_runtime_plugin_synced_idx` | 否 | `BTREE` | `plugin_id`, `synced_at` | 108 | — |
| `service_runtime_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_key` | 5 | — |
| `service_runtime_service_unique` | 是 | `BTREE` | `service_id` | 164 | — |
| `service_runtime_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 2 | — |
...
| `service_upstream_bindings_product_upstream_binding_id_foreign` | 否 | `BTREE` | `product_upstream_binding_id` | 3 | — |
| `service_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 1 | — |
| `service_upstream_plugin_sync_idx` | 否 | `BTREE` | `plugin_id`, `last_synced_at` | 3 | — |
| `service_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_snapshot` | 3 | — |
| `service_upstream_service_idx` | 否 | `BTREE` | `service_id` | 3 | — |
| `service_upstream_unique` | 是 | `BTREE` | `service_id`, `plugin_id`, `upstream_service_id` | 3 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 136 | — |
| `services_expires_at_index` | 否 | `BTREE` | `expires_at` | 136 | — |
| `services_invoice_id_idx` | 否 | `BTREE` | `invoice_id` | 46 | — |
| `services_order_id_idx` | 否 | `BTREE` | `order_id` | 136 | — |
| `services_product_id_idx` | 否 | `BTREE` | `product_id` | 48 | — |
| `services_status_expires_at_id_idx` | 否 | `BTREE` | `status`, `expires_at`, `id` | 136 | — |
| `services_trace_id_idx` | 否 | `BTREE` | `trace_id` | 65 | — |
| `services_user_id_index` | 否 | `BTREE` | `user_id` | 94 | — |
| `services_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 136 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 115 | — |
| `settings_group_key_unique` | 是 | `BTREE` | `group_key`, `item_key` | 115 | — |
...
| `supplier_plugin_unique` | 是 | `BTREE` | `supplier_id`, `plugin_id`, `environment` | 1 | — |
...
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 0 | — |
| `suppliers_code_unique` | 是 | `BTREE` | `code` | 0 | — |
| `suppliers_status_sort_order_index` | 否 | `BTREE` | `status`, `sort_order` | 0 | — |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | — | PRI | auto_increment | — | — | — |
| 2 | `second_product_group_id` | `bigint unsigned` | 否 | — | MUL | — | — | — | → second_product_groups.id |
| 3 | `name` | `varchar(100)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | 名称 |
| 4 | `slug` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | URL标识 |
| 5 | `description` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组说明 |
| 6 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序 |
| 7 | `is_visible` | `tinyint unsigned` | 否 | `1` | — | — | — | — | 前台可见 |
...
| `uq_third_second_slug` | 是 | `BTREE` | `second_product_group_id`, `slug` | 25 | — |
...
| `PRIMARY` | 是 | `BTREE` | `id` | 166 | — |
| `ticket_replies_ticket_created_id_idx` | 否 | `BTREE` | `ticket_id`, `created_at`, `id` | 166 | — |
...
| `PRIMARY` | 是 | `BTREE` | `id` | 63 | — |
| `tickets_service_id_idx` | 否 | `BTREE` | `service_id` | 29 | — |
| `tickets_status_updated_at_idx` | 否 | `BTREE` | `status`, `updated_at` | 61 | — |
| `tickets_user_id_index` | 否 | `BTREE` | `user_id` | 27 | — |
| `tickets_user_status_updated_at_idx` | 否 | `BTREE` | `user_id`, `status`, `updated_at` | 63 | — |
| `tickets_user_updated_at_idx` | 否 | `BTREE` | `user_id`, `updated_at`, `id` | 63 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 105 | — |
| `user_notifications_type_index` | 否 | `BTREE` | `type` | 6 | — |
| `user_notifications_user_id_created_at_index` | 否 | `BTREE` | `user_id`, `created_at` | 104 | — |
| `user_notifications_user_id_read_at_index` | 否 | `BTREE` | `user_id`, `read_at` | 54 | — |
...
| 16 | `login_email_alert` | `tinyint` | 否 | `1` | MUL | — | — | — | 登录邮件提醒 0关闭 1开启 |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 479 | — |
| `users_created_at_idx` | 否 | `BTREE` | `created_at` | 479 | — |
| `users_email_unique` | 是 | `BTREE` | `email` | 326 | — |
...
| `users_referral_code_unique` | 是 | `BTREE` | `referral_code` | 147 | — |
| `users_referrer_user_id_index` | 否 | `BTREE` | `referrer_user_id` | 5 | — |
| `users_status_id_idx` | 否 | `BTREE` | `status`, `id` | 479 | — |
| `users_verification_certify_id_idx` | 否 | `BTREE` | `verification_certify_id` | 111 | — |
| `users_verification_mix_idx` | 否 | `BTREE` | `is_verified`, `verification_status`, `id` | 479 | — |
| `users_verification_status_id_idx` | 否 | `BTREE` | `verification_status`, `id` | 479 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 93 | — |
| `verification_histories_user_id_id_idx` | 否 | `BTREE` | `user_id`, `id` | 93 | — |
| `verification_histories_user_id_submitted_at_index` | 否 | `BTREE` | `user_id`, `submitted_at` | 93 | — |
| `verification_histories_verification_certify_id_index` | 否 | `BTREE` | `verification_certify_id` | 90 | — |
