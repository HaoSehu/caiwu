...
const seoConfig = computed(() => {
  ...
  if (props.contentType === 'notice') {
    return {
      title: '官方公告',
      description: appStore.siteDescription || '查看创欧云的维护通知、活动公告与产品发布动态',
      keywords: '公告,维护通知,产品动态,创欧云',
    }
  }

  if (props.contentType === 'help') {
    return {
      title: '帮助中心',
      description: '云服务器、独立服务器、账单支付与实名认证相关的常见问题文档',
      keywords: '帮助中心,使用文档,常见问题,创欧云',
    }
  }
