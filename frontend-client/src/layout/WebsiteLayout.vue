      ...
      <div class="container header-bar">
        ...
        <div class="header-actions">
          <template v-if="isLoggedIn">
            <router-link to="/client/dashboard" class="header-register">进入控制台</router-link>
          </template>
          <template v-else>
            <router-link to="/client/login" class="header-link">登录</router-link>
            <router-link to="/client/register" class="header-register">免费注册</router-link>
          </template>
        </div>
    ...
    <transition name="mobile-menu-panel">
      <div v-if="isMobile && mobileNavVisible" class="mobile-menu-panel">
        ...
        <div class="mobile-action-group">
          <router-link v-if="isLoggedIn" to="/client/dashboard" class="mobile-action-btn primary">控制台</router-link>
          <template v-else>
            <router-link to="/client/login" class="mobile-action-btn">登录</router-link>
            <router-link to="/client/register" class="mobile-action-btn primary">免费注册</router-link>
          </template>
        </div>
      </div>
    </transition>
        ...
        <div class="footer-top">
          ...
          <div class="footer-columns">
            ...
            <div class="footer-col">
              ...
              <router-link to="/client/tickets">工单系统</router-link>
              <router-link to="/about">关于我们</router-link>
            </div>

            <div class="footer-col">
              <h4>账户</h4>
              <router-link to="/client/register">免费注册</router-link>
              <router-link to="/client/login">账户登录</router-link>
              <router-link to="/client/dashboard">进入控制台</router-link>
              <router-link to="/client/verification">实名认证</router-link>
            </div>
          </div>
        </div>
...
const navigationItems = [
  ...
  { to: '/products', label: '产品', match: ['Products', 'ProductsPurchase', 'ProductsPurchaseWithChild', 'ProductDetail'], menuId: 'products' },
  { to: '/notices', label: '公告', match: ['WebsiteNotices', 'WebsiteNoticeDetail'], menuId: 'notices' },
  { to: '/help', label: '帮助', match: ['WebsiteHelp', 'WebsiteHelpDetail'], menuId: 'help' },
  { to: '/about', label: '其他', match: ['About'], menuId: 'about' },
]
...
const isLoggedIn = computed(() => userStore.isLoggedIn || !!getToken())
