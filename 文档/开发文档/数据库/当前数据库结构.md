...
- 文档性质：参考资料 / 实库结构快照
- 生成时间：`2026-07-21 17:12:58 +08:00`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `account_transactions` | BASE TABLE | InnoDB | 731 | 160 KB | 208 KB | 1,741 | utf8mb4_unicode_ci | 账户流水表，记录现金账户、授信账户、推荐奖励账户的每一次余额变化 |
| `activity_logs` | BASE TABLE | InnoDB | 12,381 | 8.52 MB | 3.56 MB | 22,381 | utf8mb4_unicode_ci | — |
| `admin_user_roles` | BASE TABLE | InnoDB | 12 | 16 KB | 32 KB | 159 | utf8mb4_unicode_ci | — |
...
| `archive_audit_logs` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | — | utf8mb4_unicode_ci | — |
| `automation_logs` | BASE TABLE | InnoDB | 1,034 | 224 KB | 224 KB | — | utf8mb4_unicode_ci | — |
...
| `coupons` | BASE TABLE | InnoDB | 79 | 16 KB | 48 KB | 85 | utf8mb4_unicode_ci | — |
| `failed_jobs` | BASE TABLE | InnoDB | 27 | 496 KB | 16 KB | 47 | utf8mb4_unicode_ci | — |
...
| `integration_plugin_runtime_logs` | BASE TABLE | InnoDB | 5,970 | 8.52 MB | 2.44 MB | 7,520 | utf8mb4_unicode_ci | — |
| `integration_plugins` | BASE TABLE | InnoDB | 1 | 16 KB | 48 KB | 5 | utf8mb4_unicode_ci | — |
| `invoice_items` | BASE TABLE | InnoDB | 2,748 | 496 KB | 80 KB | 2,770 | utf8mb4_unicode_ci | 账单明细表，记录账单内每个收费项目和快照信息 |
| `invoices` | BASE TABLE | InnoDB | 2,912 | 1.52 MB | 1.5 MB | 2,987 | utf8mb4_unicode_ci | 账单主表，所有购买、续费、充值、扣款和退款流程以账单为财务入口 |
| `jobs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 910 | utf8mb4_unicode_ci | — |
| `media_files` | BASE TABLE | InnoDB | 18 | 16 KB | 48 KB | — | utf8mb4_unicode_ci | — |
| `member_levels` | BASE TABLE | InnoDB | 5 | 16 KB | 48 KB | 9 | utf8mb4_unicode_ci | — |
| `message_logs` | BASE TABLE | InnoDB | 726 | 12.52 MB | 656 KB | 2,329 | utf8mb4_unicode_ci | — |
| `migrations` | BASE TABLE | InnoDB | 160 | 16 KB | 0 B | 174 | utf8mb4_unicode_ci | — |
| `notice_reads` | BASE TABLE | InnoDB | 99 | 16 KB | 48 KB | 142 | utf8mb4_unicode_ci | — |
| `notification_templates` | BASE TABLE | InnoDB | 56 | 256 KB | 32 KB | 981 | utf8mb4_unicode_ci | — |
| `operation_logs` | BASE TABLE | InnoDB | 143,211 | 71.59 MB | 28.09 MB | 154,102 | utf8mb4_unicode_ci | — |
...
| `payment_callbacks` | BASE TABLE | InnoDB | 344 | 288 KB | 96 KB | 476 | utf8mb4_unicode_ci | 支付回调审计表，保存第三方通知、查询、退款等回调验签结果 |
| `payments` | BASE TABLE | InnoDB | 361 | 304 KB | 160 KB | 364 | utf8mb4_unicode_ci | 第三方支付记录表，仅记录真实外部资金流入和退款状态，不记录余额/免费/手工开服 |
| `personal_access_tokens` | BASE TABLE | InnoDB | 84 | 16 KB | 48 KB | 121 | utf8mb4_unicode_ci | — |
| `product_upstream_bindings` | BASE TABLE | InnoDB | 159 | 9.52 MB | 96 KB | 197 | utf8mb4_unicode_ci | — |
| `products` | BASE TABLE | InnoDB | 259 | 10.52 MB | 48 KB | 379 | utf8mb4_unicode_ci | 商品表，记录可售卖产品的分类、定价、库存、上游绑定和开通策略 |
| `recharge_records` | BASE TABLE | InnoDB | 0 | 16 KB | 112 KB | 1 | utf8mb4_unicode_ci | — |
...
| `refunds` | BASE TABLE | InnoDB | 0 | 16 KB | 64 KB | 1 | utf8mb4_unicode_ci | — |
| `roles` | BASE TABLE | InnoDB | 299 | 64 KB | 16 KB | 397 | utf8mb4_unicode_ci | — |
| `schedule_run_logs` | BASE TABLE | InnoDB | 145,619 | 35.56 MB | 20.06 MB | 148,518 | utf8mb4_unicode_ci | — |
| `schedule_task_runs` | BASE TABLE | InnoDB | 805 | 304 KB | 224 KB | 809 | utf8mb4_unicode_ci | — |
| `schedule_ticks` | BASE TABLE | InnoDB | 67 | 16 KB | 48 KB | — | utf8mb4_unicode_ci | — |
...
| `service_provision_attempts` | BASE TABLE | InnoDB | 216 | 96 KB | 80 KB | 420 | utf8mb4_unicode_ci | — |
| `service_runtime_snapshots` | BASE TABLE | InnoDB | 175 | 208 KB | 80 KB | 193 | utf8mb4_unicode_ci | — |
| `service_upstream_bindings` | BASE TABLE | InnoDB | 174 | 144 KB | 112 KB | 206 | utf8mb4_unicode_ci | — |
| `services` | BASE TABLE | InnoDB | 190 | 1.52 MB | 128 KB | 300 | utf8mb4_unicode_ci | 服务实例表，记录用户已购买产品的生命周期、计费、上游和续费状态 |
...
| `supplier_plugin_bindings` | BASE TABLE | InnoDB | 43 | 16 KB | 64 KB | 87 | utf8mb4_unicode_ci | — |
| `suppliers` | BASE TABLE | InnoDB | 83 | 16 KB | 32 KB | 91 | utf8mb4_unicode_ci | — |
...
| `users` | BASE TABLE | InnoDB | 876 | 208 KB | 288 KB | 988,048 | utf8mb4_unicode_ci | — |
| `verification_histories` | BASE TABLE | InnoDB | 90 | 64 KB | 48 KB | 96 | utf8mb4_unicode_ci | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `account_transactions_created_at_idx` | 否 | `BTREE` | `created_at` | 675 | — |
| `account_transactions_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 693 | — |
| `account_transactions_trace_id_idx` | 否 | `BTREE` | `trace_id` | 706 | — |
| `account_transactions_user_account_created_idx` | 否 | `BTREE` | `user_id`, `account_type`, `created_at`, `id` | 734 | — |
| `account_transactions_user_event_created_idx` | 否 | `BTREE` | `user_id`, `event_type`, `created_at` | 727 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 734 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `activity_logs_actor_id_index` | 否 | `BTREE` | `actor_id` | 376 | — |
| `activity_logs_created_at_index` | 否 | `BTREE` | `created_at` | 4,451 | — |
| `activity_logs_module_action_index` | 否 | `BTREE` | `module`, `action` | 1,021 | — |
| `activity_logs_subject_type_subject_id_index` | 否 | `BTREE` | `subject_type`, `subject_id` | 240 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 13,790 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `automation_logs_object_idx` | 否 | `BTREE` | `object_type`, `object_id` | 369 | — |
| `automation_logs_task_key_index` | 否 | `BTREE` | `task_key` | 6 | — |
| `automation_logs_unique_rule` | 是 | `BTREE` | `task_key`, `action`, `object_type`, `object_id`, `rule_key` | 1,041 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 1,041 | — |
...
| `idx_stage2_coupon_campaigns_last_coupon_id` | 否 | `BTREE` | `last_coupon_id` | 10 | — |
...
| `coupons_code_unique` | 是 | `BTREE` | `code` | 86 | — |
| `coupons_status_sort_idx` | 否 | `BTREE` | `status`, `sort_order` | 2 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 86 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `failed_jobs_uuid_unique` | 是 | `BTREE` | `uuid` | 33 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 33 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `first_product_groups_code_unique` | 是 | `BTREE` | `code` | 16 | — |
| `first_product_groups_slug_unique` | 是 | `BTREE` | `slug` | 16 | — |
...
| `gateway_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 63 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `plugin_runtime_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `created_at` | 4,290 | — |
| `plugin_runtime_domain_action_created_idx` | 否 | `BTREE` | `domain`, `action`, `created_at` | 5,417 | — |
| `plugin_runtime_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 4,527 | — |
| `plugin_runtime_status_created_idx` | 否 | `BTREE` | `status`, `created_at` | 4,320 | — |
| `plugin_runtime_trace_idx` | 否 | `BTREE` | `trace_id` | 7,956 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 7,956 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `invoice_items_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 2,769 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,831 | — |
...
| `invoices_invoice_no_unique` | 是 | `BTREE` | `invoice_no` | 2,959 | — |
...
| `invoices_status_due_date_index` | 否 | `BTREE` | `status`, `due_date` | 725 | — |
| `invoices_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 1,022 | — |
| `invoices_trace_id_idx` | 否 | `BTREE` | `trace_id` | 2,924 | — |
| `invoices_user_id_index` | 否 | `BTREE` | `user_id` | 465 | — |
| `invoices_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 2,796 | — |
| `invoices_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 2,959 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 3,076 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `message_logs_channel_created_at_idx` | 否 | `BTREE` | `channel`, `created_at` | 1,584 | — |
| `message_logs_channel_driver_idx` | 否 | `BTREE` | `channel`, `driver_key`, `created_at` | 1,589 | — |
| `message_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 1,589 | — |
| `message_logs_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 269 | — |
| `message_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 1,586 | — |
| `message_logs_recipient_created_at_idx` | 否 | `BTREE` | `recipient`, `created_at` | 1,835 | — |
| `message_logs_request_id_idx` | 否 | `BTREE` | `request_id` | 21 | — |
| `message_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 1,839 | — |
...
| `notice_reads_user_id_article_id_unique` | 是 | `BTREE` | `user_id`, `article_id` | 108 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `operation_logs_created_at_idx` | 否 | `BTREE` | `created_at` | 71,105 | — |
| `operation_logs_module_created_at_index` | 否 | `BTREE` | `module`, `created_at` | 100,612 | — |
| `operation_logs_module_subject_created_idx` | 否 | `BTREE` | `module`, `subject_id`, `created_at`, `id` | 135,432 | — |
| `operation_logs_user_created_at_idx` | 否 | `BTREE` | `user_id`, `created_at` | 79,803 | — |
| `operation_logs_user_id_user_type_index` | 否 | `BTREE` | `user_id`, `user_type` | 322 | — |
| `operation_logs_user_type_created_at_idx` | 否 | `BTREE` | `user_id`, `user_type`, `created_at` | 78,144 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 135,432 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payment_callbacks_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `received_at` | 308 | — |
| `payment_callbacks_gateway_trade_no_idx` | 否 | `BTREE` | `gateway_trade_no` | 212 | — |
| `payment_callbacks_payment_type_unique` | 是 | `BTREE` | `payment_id`, `callback_type` | 356 | — |
| `payment_callbacks_plugin_received_idx` | 否 | `BTREE` | `plugin_id`, `received_at` | 305 | — |
| `payment_callbacks_trace_id_idx` | 否 | `BTREE` | `trace_id` | 115 | — |
| `payment_callbacks_verified_received_idx` | 否 | `BTREE` | `is_verified`, `received_at` | 322 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 356 | — |
...
| `payments_order_status_idx` | 否 | `BTREE` | `order_id`, `status` | 191 | — |
| `payments_payment_no_unique` | 是 | `BTREE` | `payment_no` | 361 | — |
| `payments_plugin_status_paid_idx` | 否 | `BTREE` | `plugin_id`, `status`, `paid_at` | 273 | — |
| `payments_plugin_trade_unique` | 是 | `BTREE` | `plugin_id`, `gateway_key`, `trade_no` | 241 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `personal_access_tokens_expires_at_index` | 否 | `BTREE` | `expires_at` | 3 | — |
| `personal_access_tokens_token_unique` | 是 | `BTREE` | `token` | 110 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 229 | — |
| `product_upstream_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `product_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 22 | — |
| `product_upstream_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 5 | — |
| `product_upstream_product_status_idx` | 否 | `BTREE` | `product_id`, `status` | 163 | — |
| `product_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status` | 4 | — |
| `product_upstream_unique` | 是 | `BTREE` | `product_id`, `supplier_plugin_binding_id`, `upstream_product_id` | 229 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_referral_reward_referred_status` | 否 | `BTREE` | `referred_user_id`, `status` | 5 | — |
| `idx_referral_reward_referrer_status` | 否 | `BTREE` | `referrer_user_id`, `status` | 4 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 146,452 | — |
| `schedule_run_logs_created_at_index` | 否 | `BTREE` | `created_at` | 78,149 | — |
| `schedule_run_logs_status_index` | 否 | `BTREE` | `status` | 2 | — |
| `schedule_run_logs_task_name_created_at_index` | 否 | `BTREE` | `task_name`, `created_at` | 146,084 | — |
...
| `schedule_task_runs_active_lookup_index` | 否 | `BTREE` | `task_key`, `status`, `queued_at` | 876 | — |
| `schedule_task_runs_source_created_at_index` | 否 | `BTREE` | `source`, `created_at` | 83 | — |
| `schedule_task_runs_status_created_at_index` | 否 | `BTREE` | `status`, `created_at` | 105 | — |
| `schedule_task_runs_task_key_created_at_index` | 否 | `BTREE` | `task_key`, `created_at` | 876 | — |
| `schedule_task_runs_tick_task_source_unique` | 是 | `BTREE` | `schedule_tick_id`, `task_key`, `source` | 876 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 73 | — |
| `schedule_ticks_daily_index_index` | 否 | `BTREE` | `daily_index` | 71 | — |
| `schedule_ticks_global_number_unique` | 是 | `BTREE` | `global_number` | 73 | — |
| `schedule_ticks_slot_started_at_unique` | 是 | `BTREE` | `slot_started_at` | 73 | — |
...
| `service_connection_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 169 | — |
...
| `service_provision_attempts_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 154 | — |
...
| `service_runtime_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_key` | 7 | — |
| `service_runtime_service_unique` | 是 | `BTREE` | `service_id` | 175 | — |
| `service_runtime_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 169 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 247 | — |
| `service_upstream_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `service_upstream_bindings_product_upstream_binding_id_foreign` | 否 | `BTREE` | `product_upstream_binding_id` | 80 | — |
| `service_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 16 | — |
| `service_upstream_plugin_sync_idx` | 否 | `BTREE` | `plugin_id`, `last_synced_at` | 120 | — |
| `service_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_snapshot` | 6 | — |
| `service_upstream_service_idx` | 否 | `BTREE` | `service_id` | 168 | — |
| `service_upstream_unique` | 是 | `BTREE` | `service_id`, `plugin_id`, `upstream_service_id` | 247 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 180 | — |
| `services_expires_at_index` | 否 | `BTREE` | `expires_at` | 180 | — |
...
| `services_status_expires_at_id_idx` | 否 | `BTREE` | `status`, `expires_at`, `id` | 180 | — |
| `services_trace_id_idx` | 否 | `BTREE` | `trace_id` | 180 | — |
| `services_user_id_index` | 否 | `BTREE` | `user_id` | 144 | — |
| `services_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 180 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 60 | — |
| `supplier_plugin_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `supplier_plugin_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 4 | — |
| `supplier_plugin_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status` | 3 | — |
| `supplier_plugin_unique` | 是 | `BTREE` | `supplier_id`, `plugin_id`, `environment` | 60 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 82 | — |
| `suppliers_code_unique` | 是 | `BTREE` | `code` | 82 | — |
