...
- 文档性质：参考资料 / 实库结构快照
- 生成时间：`2026-07-08 02:33:20 +08:00`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `account_transactions` | BASE TABLE | InnoDB | 1,222 | 224 KB | 320 KB | 1,652 | utf8mb4_unicode_ci | 账户流水表，记录现金账户、授信账户、推荐奖励账户的每一次余额变化 |
| `activity_logs` | BASE TABLE | InnoDB | 6,953 | 3.52 MB | 2.17 MB | 8,068 | utf8mb4_unicode_ci | — |
| `admin_user_roles` | BASE TABLE | InnoDB | 2 | 16 KB | 32 KB | 115 | utf8mb4_unicode_ci | — |
...
| `automation_logs` | BASE TABLE | InnoDB | 607 | 144 KB | 192 KB | 663 | utf8mb4_unicode_ci | — |
...
| `failed_jobs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 14 | utf8mb4_unicode_ci | — |
| `first_product_groups` | BASE TABLE | InnoDB | 8 | 16 KB | 112 KB | 14 | utf8mb4_unicode_ci | — |
| `gateway_logs` | BASE TABLE | InnoDB | 53 | 64 KB | 112 KB | 55 | utf8mb4_unicode_ci | — |
| `integration_plugin_bindings` | BASE TABLE | InnoDB | 11 | 16 KB | 80 KB | 13 | utf8mb4_unicode_ci | — |
| `integration_plugin_configs` | BASE TABLE | InnoDB | 6 | 16 KB | 16 KB | 10 | utf8mb4_unicode_ci | — |
| `integration_plugin_runtime_logs` | BASE TABLE | InnoDB | 2,691 | 4.52 MB | 832 KB | 4,287 | utf8mb4_unicode_ci | — |
| `integration_plugins` | BASE TABLE | InnoDB | 11 | 48 KB | 48 KB | 20 | utf8mb4_unicode_ci | — |
| `invoice_items` | BASE TABLE | InnoDB | 2,116 | 384 KB | 80 KB | 2,146 | utf8mb4_unicode_ci | 账单明细表，记录账单内每个收费项目和快照信息 |
| `invoices` | BASE TABLE | InnoDB | 2,135 | 1.52 MB | 1.09 MB | 2,172 | utf8mb4_unicode_ci | 账单主表，所有购买、续费、充值、扣款和退款流程以账单为财务入口 |
| `jobs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 106 | utf8mb4_unicode_ci | — |
...
| `migrations` | BASE TABLE | InnoDB | 118 | 16 KB | 0 B | 153 | utf8mb4_unicode_ci | — |
| `notice_reads` | BASE TABLE | InnoDB | 30 | 16 KB | 48 KB | 42 | utf8mb4_unicode_ci | — |
| `notification_logs` | BASE TABLE | InnoDB | 610 | 10.5 MB | 720 KB | 1,495 | utf8mb4_unicode_ci | — |
| `notification_templates` | BASE TABLE | InnoDB | 56 | 176 KB | 32 KB | 111 | utf8mb4_unicode_ci | — |
| `operation_logs` | BASE TABLE | InnoDB | 120,049 | 51.58 MB | 27.09 MB | 130,241 | utf8mb4_unicode_ci | — |
| `orders` | BASE TABLE | InnoDB | 255 | 272 KB | 176 KB | 281 | utf8mb4_unicode_ci | — |
| `password_reset_tokens` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | — | utf8mb4_unicode_ci | — |
| `payment_callbacks` | BASE TABLE | InnoDB | 270 | 240 KB | 96 KB | 421 | utf8mb4_unicode_ci | 支付回调审计表，保存第三方通知、查询、退款等回调验签结果 |
| `payments` | BASE TABLE | InnoDB | 269 | 240 KB | 160 KB | 282 | utf8mb4_unicode_ci | 第三方支付记录表，仅记录真实外部资金流入和退款状态，不记录余额/免费/手工开服 |
| `personal_access_tokens` | BASE TABLE | InnoDB | 162 | 64 KB | 48 KB | 225 | utf8mb4_unicode_ci | — |
| `product_upstream_bindings` | BASE TABLE | InnoDB | 138 | 8.52 MB | 96 KB | 146 | utf8mb4_unicode_ci | — |
| `products` | BASE TABLE | InnoDB | 141 | 8.52 MB | 128 KB | 152 | utf8mb4_unicode_ci | 商品表，记录可售卖产品的分类、定价、库存、上游绑定和开通策略 |
...
| `roles` | BASE TABLE | InnoDB | 4 | 16 KB | 16 KB | 117 | utf8mb4_unicode_ci | — |
| `schedule_run_logs` | BASE TABLE | InnoDB | 66,493 | 13.52 MB | 10.06 MB | 67,915 | utf8mb4_unicode_ci | — |
| `schedule_task_runs` | BASE TABLE | InnoDB | 1 | 16 KB | 64 KB | 2 | utf8mb4_unicode_ci | — |
| `schedule_ticks` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | 1 | utf8mb4_unicode_ci | — |
| `second_product_groups` | BASE TABLE | InnoDB | 16 | 16 KB | 112 KB | 22 | utf8mb4_unicode_ci | — |
| `service_connection_snapshots` | BASE TABLE | InnoDB | 152 | 288 KB | 80 KB | 154 | utf8mb4_unicode_ci | — |
| `service_provision_attempts` | BASE TABLE | InnoDB | 199 | 96 KB | 80 KB | 405 | utf8mb4_unicode_ci | — |
| `service_runtime_snapshots` | BASE TABLE | InnoDB | 152 | 224 KB | 80 KB | 154 | utf8mb4_unicode_ci | — |
| `service_upstream_bindings` | BASE TABLE | InnoDB | 152 | 144 KB | 112 KB | 154 | utf8mb4_unicode_ci | — |
| `services` | BASE TABLE | InnoDB | 120 | 512 KB | 128 KB | 191 | utf8mb4_unicode_ci | 服务实例表，记录用户已购买产品的生命周期、计费、上游和续费状态 |
| `sessions` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | — | utf8mb4_unicode_ci | — |
| `settings` | BASE TABLE | InnoDB | 112 | 96 KB | 16 KB | 277 | utf8mb4_unicode_ci | — |
| `sms_logs` | BASE TABLE | InnoDB | 24 | 16 KB | 80 KB | 26 | utf8mb4_unicode_ci | — |
| `supplier_plugin_bindings` | BASE TABLE | InnoDB | 2 | 16 KB | 64 KB | 4 | utf8mb4_unicode_ci | — |
| `suppliers` | BASE TABLE | InnoDB | 2 | 16 KB | 32 KB | 4 | utf8mb4_unicode_ci | — |
| `third_product_groups` | BASE TABLE | InnoDB | 22 | 16 KB | 96 KB | 25 | utf8mb4_unicode_ci | — |
...
| `user_notifications` | BASE TABLE | InnoDB | 58 | 16 KB | 48 KB | 67 | utf8mb4_unicode_ci | — |
| `users` | BASE TABLE | InnoDB | 463 | 128 KB | 160 KB | 464 | utf8mb4_unicode_ci | — |
| `verification_histories` | BASE TABLE | InnoDB | 81 | 64 KB | 48 KB | 91 | utf8mb4_unicode_ci | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `account_transactions_created_at_idx` | 否 | `BTREE` | `created_at` | 608 | — |
| `account_transactions_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 621 | — |
| `account_transactions_trace_id_idx` | 否 | `BTREE` | `trace_id` | 544 | — |
| `account_transactions_user_account_created_idx` | 否 | `BTREE` | `user_id`, `account_type`, `created_at`, `id` | 1,222 | — |
| `account_transactions_user_event_created_idx` | 否 | `BTREE` | `user_id`, `event_type`, `created_at` | 615 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 1,222 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `activity_logs_actor_id_index` | 否 | `BTREE` | `actor_id` | 7 | — |
| `activity_logs_created_at_index` | 否 | `BTREE` | `created_at` | 3,105 | — |
| `activity_logs_module_action_index` | 否 | `BTREE` | `module`, `action` | 530 | — |
| `activity_logs_subject_type_subject_id_index` | 否 | `BTREE` | `subject_type`, `subject_id` | 73 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 6,599 | — |
...
| 12 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 13 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 14 | `product_type` | `varchar(50)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |

#### 索引

| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `first_product_groups_code_unique` | 是 | `BTREE` | `code` | 8 | — |
| `first_product_groups_legacy_product_type_index` | 否 | `BTREE` | `legacy_product_type` | 8 | — |
| `first_product_groups_slug_unique` | 是 | `BTREE` | `slug` | 8 | — |
| `idx_first_group_code_visible` | 否 | `BTREE` | `code`, `is_visible` | 8 | — |
| `idx_first_group_visible` | 否 | `BTREE` | `is_visible` | 1 | — |
| `idx_first_product_groups_product_type` | 否 | `BTREE` | `product_type` | 8 | — |
| `idx_first_product_groups_visible_sort` | 否 | `BTREE` | `is_visible`, `sort_order` | 8 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `gateway_logs_created_at_index` | 否 | `BTREE` | `created_at` | 53 | — |
| `gateway_logs_gateway_action_index` | 否 | `BTREE` | `gateway`, `action` | 3 | — |
| `gateway_logs_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `created_at` | 53 | — |
| `gateway_logs_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 1 | — |
| `gateway_logs_out_trade_no_index` | 否 | `BTREE` | `out_trade_no` | 43 | — |
| `gateway_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 53 | — |
| `gateway_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 25 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 53 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `integration_plugin_configs_plugin_unique` | 是 | `BTREE` | `plugin_id` | 6 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `plugin_runtime_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `created_at` | 1,357 | — |
| `plugin_runtime_domain_action_created_idx` | 否 | `BTREE` | `domain`, `action`, `created_at` | 1,525 | — |
| `plugin_runtime_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 1,481 | — |
| `plugin_runtime_status_created_idx` | 否 | `BTREE` | `status`, `created_at` | 1,374 | — |
| `plugin_runtime_trace_idx` | 否 | `BTREE` | `trace_id` | 2,691 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,691 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `integration_plugins_domain_key_unique` | 是 | `BTREE` | `domain`, `plugin_key` | 11 | — |
| `integration_plugins_domain_slug_unique` | 是 | `BTREE` | `domain`, `slug` | 11 | — |
| `integration_plugins_domain_status_index` | 否 | `BTREE` | `domain`, `status` | 9 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 11 | — |
...
| 22 | `due_date` | `date` | 是 | `NULL` | — | — | — | — | — |
| 23 | `paid_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 账单支付完成时间 |
| 24 | `deleted_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 25 | `refund_trace_id` | `varchar(64)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 退款链路追踪号 |
| 26 | `refund_method` | `varchar(32)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 退款方式 |
| 27 | `refund_amount` | `decimal(12,2)` | 是 | `NULL` | — | — | — | — | 退款金额 |
| 28 | `refunded_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 退款完成时间 |
| 29 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 创建时间 |
| 30 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 更新时间 |
| 31 | `remark` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 账单备注 |
| 32 | `operator` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 操作人快照 |
| 33 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 链路追踪号 |
...
| `invoices_invoice_no_unique` | 是 | `BTREE` | `invoice_no` | 2,135 | — |
| `invoices_order_id_idx` | 否 | `BTREE` | `order_id` | 247 | — |
| `invoices_product_id_idx` | 否 | `BTREE` | `product_id` | 49 | — |
| `invoices_service_id_idx` | 否 | `BTREE` | `service_id` | 128 | — |
| `invoices_status_due_date_index` | 否 | `BTREE` | `status`, `due_date` | 694 | — |
| `invoices_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 893 | — |
| `invoices_trace_id_idx` | 否 | `BTREE` | `trace_id` | 1,539 | — |
| `invoices_user_id_index` | 否 | `BTREE` | `user_id` | 309 | — |
| `invoices_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 2,074 | — |
| `invoices_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 2,135 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,135 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `notification_logs_channel_created_at_idx` | 否 | `BTREE` | `channel`, `created_at` | 610 | — |
...
| 22 | `deleted_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 23 | `created_at` | `timestamp` | 是 | `NULL` | MUL | — | — | — | — |
| 24 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 25 | `remark` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 备注 |
| 26 | `operator` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 操作人 |
| 27 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 链路追踪号 |
| 28 | `projection_type` | `varchar(32)` | 否 | `provisioning` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 内部投影类型：provisioning=开通投影 |
...
| `payment_callbacks_gateway_trade_no_idx` | 否 | `BTREE` | `gateway_trade_no` | 171 | — |
| `payment_callbacks_payment_type_unique` | 是 | `BTREE` | `payment_id`, `callback_type` | 270 | — |
| `payment_callbacks_plugin_received_idx` | 否 | `BTREE` | `plugin_id`, `received_at` | 268 | — |
| `payment_callbacks_trace_id_idx` | 否 | `BTREE` | `trace_id` | 77 | — |
| `payment_callbacks_verified_received_idx` | 否 | `BTREE` | `is_verified`, `received_at` | 269 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 270 | — |
...
| 13 | `deleted_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 14 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 创建时间 |
| 15 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 更新时间 |
| 16 | `remark` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 支付备注 |
| 17 | `operator` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 操作人快照 |
| 18 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 链路追踪号 |

#### 索引

| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payments_invoice_gateway_status_id_idx` | 否 | `BTREE` | `invoice_id`, `status`, `id` | 269 | — |
| `payments_invoice_status_created_at_idx` | 否 | `BTREE` | `invoice_id`, `status`, `created_at`, `id` | 269 | — |
| `payments_order_status_idx` | 否 | `BTREE` | `order_id`, `status` | 147 | — |
| `payments_payment_no_unique` | 是 | `BTREE` | `payment_no` | 269 | — |
| `payments_plugin_status_paid_idx` | 否 | `BTREE` | `plugin_id`, `status`, `paid_at` | 220 | — |
| `payments_plugin_trade_unique` | 是 | `BTREE` | `plugin_id`, `gateway_key`, `trade_no` | 173 | — |
| `payments_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 220 | — |
| `payments_trace_id_idx` | 否 | `BTREE` | `trace_id` | 79 | — |
| `payments_trade_no_index` | 否 | `BTREE` | `trade_no` | 172 | — |
| `payments_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 269 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 269 | — |
...
| `personal_access_tokens_token_unique` | 是 | `BTREE` | `token` | 162 | — |
| `personal_access_tokens_tokenable_type_tokenable_id_index` | 否 | `BTREE` | `tokenable_type`, `tokenable_id` | 30 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 162 | — |
...
| 2 | `first_product_group_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | 一级商品分组ID |
| 3 | `second_product_group_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | 二级商品分组ID |
| 4 | `third_product_group_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | 三级商品分组ID |
| 5 | `service_type_code` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 服务类型代码，用于前后端能力分流 |
| 6 | `product_type` | `varchar(30)` | 否 | — | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 商品类型：vps/dedicated/hosting/domain/other |
| 7 | `custom_display_name` | `varchar(190)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 自定义展示名称 |
| 8 | `remark` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 商品备注 |
| 9 | `pricing` | `json` | 否 | — | — | — | — | — | 周期价格 JSON，如 monthly/quarterly/annually |
| 10 | `setup_fee` | `decimal(12,2)` | 否 | `0.00` | — | — | — | — | 初装费 |
| 11 | `config_options` | `json` | 是 | `NULL` | — | — | — | — | 可选配置项 JSON |
| 12 | `purchase_requires` | `json` | 是 | `NULL` | — | — | — | — | 购买限制 JSON，如实名认证、手机号要求 |
| 13 | `stock` | `int` | 否 | `-1` | — | — | — | — | 库存数量，-1 表示不限 |
| 14 | `status` | `tinyint` | 否 | `1` | MUL | — | — | — | 商品状态：0下架 1上架 |
| 15 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序值，越小越靠前 |
| 16 | `auto_setup` | `tinyint` | 否 | `0` | — | — | — | — | 是否自动开通：0手动 1自动 |
| 17 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 创建时间 |
| 18 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 更新时间 |
| 19 | `deleted_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 软删除时间 |

#### 索引

| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_product_group_status` | 否 | `BTREE` | `second_product_group_id`, `third_product_group_id`, `status` | 28 | — |
| `idx_product_second_status` | 否 | `BTREE` | `second_product_group_id`, `status` | 19 | — |
| `idx_product_status_groups` | 否 | `BTREE` | `status`, `first_product_group_id`, `second_product_group_id` | 19 | — |
| `idx_product_third_status` | 否 | `BTREE` | `third_product_group_id`, `status` | 26 | — |
...
| `idx_products_second_product_group_id` | 否 | `BTREE` | `second_product_group_id` | 17 | — |
| `idx_products_third_product_group_id` | 否 | `BTREE` | `third_product_group_id` | 24 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 141 | — |
| `products_type_status_index` | 否 | `BTREE` | `product_type`, `status` | 7 | — |
...
| `schedule_task_runs_source_created_at_index` | 否 | `BTREE` | `source`, `created_at` | 1 | — |
| `schedule_task_runs_status_created_at_index` | 否 | `BTREE` | `status`, `created_at` | 1 | — |
| `schedule_task_runs_task_key_created_at_index` | 否 | `BTREE` | `task_key`, `created_at` | 1 | — |
| `schedule_task_runs_tick_task_source_unique` | 是 | `BTREE` | `schedule_tick_id`, `task_key`, `source` | 1 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 152 | — |
| `service_connection_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `service_connection_plugin_checked_idx` | 否 | `BTREE` | `plugin_id`, `checked_at` | 125 | — |
| `service_connection_provider_type_idx` | 否 | `BTREE` | `provider_key`, `connection_type` | 1 | — |
| `service_connection_service_type_unique` | 是 | `BTREE` | `service_id`, `connection_type` | 152 | — |
| `service_connection_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 152 | — |
...
| `service_runtime_plugin_synced_idx` | 否 | `BTREE` | `plugin_id`, `synced_at` | 120 | — |
| `service_runtime_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_key` | 3 | — |
| `service_runtime_service_unique` | 是 | `BTREE` | `service_id` | 152 | — |
| `service_runtime_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 152 | — |
...
| `service_upstream_plugin_sync_idx` | 否 | `BTREE` | `plugin_id`, `last_synced_at` | 96 | — |
| `service_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_snapshot` | 3 | — |
| `service_upstream_service_idx` | 否 | `BTREE` | `service_id` | 152 | — |
| `service_upstream_unique` | 是 | `BTREE` | `service_id`, `plugin_id`, `upstream_service_id` | 152 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 58 | — |
| `user_notifications_type_index` | 否 | `BTREE` | `type` | 6 | — |
| `user_notifications_user_id_created_at_index` | 否 | `BTREE` | `user_id`, `created_at` | 58 | — |
| `user_notifications_user_id_read_at_index` | 否 | `BTREE` | `user_id`, `read_at` | 27 | — |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | — | PRI | auto_increment | — | — | — |
| 2 | `email` | `varchar(100)` | 否 | — | UNI | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 3 | `password` | `varchar(255)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 4 | `nickname` | `varchar(50)` | 否 | 空字符串 | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 5 | `phone` | `varchar(20)` | 否 | — | UNI | — | utf8mb4 | utf8mb4_unicode_ci | — |
