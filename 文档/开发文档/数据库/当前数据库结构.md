...
- 文档性质：参考资料 / 实库结构快照
- 生成时间：`2026-07-08 13:15:01 +08:00`
...
| `message_logs` | BASE TABLE | InnoDB | 1,716 | 9.52 MB | 752 KB | 2,048 | utf8mb4_unicode_ci | — |
...
### 2.14 `integration_plugin_bindings`
...
### 2.16 `integration_plugin_runtime_logs`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `message_logs_channel_created_at_idx` | 否 | `BTREE` | `channel`, `created_at` | 1,487 | — |
| `message_logs_channel_driver_idx` | 否 | `BTREE` | `channel`, `driver_key`, `created_at` | 1,487 | — |
| `message_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 1,487 | — |
| `message_logs_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 267 | — |
| `message_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 1,487 | — |
| `message_logs_recipient_created_at_idx` | 否 | `BTREE` | `recipient`, `created_at` | 1,491 | — |
| `message_logs_request_id_idx` | 否 | `BTREE` | `request_id` | 13 | — |
| `message_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 1,492 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 1,716 | — |
...
### 2.33 `product_upstream_bindings`
...
### 2.43 `service_connection_snapshots`
...
### 2.44 `service_provision_attempts`
...
### 2.45 `service_runtime_snapshots`
...
### 2.46 `service_upstream_bindings`
