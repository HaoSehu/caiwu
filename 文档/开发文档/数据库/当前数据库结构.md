...
- 文档性质：参考资料 / 实库结构快照
- 生成时间：`2026-07-04 03:20:02 +08:00`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `account_transactions` | BASE TABLE | InnoDB | 619 | 144 KB | 208 KB | 621 | utf8mb4_unicode_ci | 账户流水表，记录现金账户、授信账户、推荐奖励账户的每一次余额变化 |
| `activity_logs` | BASE TABLE | InnoDB | 0 | 16 KB | 64 KB | 1 | utf8mb4_unicode_ci | — |
| `admin_user_roles` | BASE TABLE | InnoDB | 2 | 16 KB | 32 KB | 47 | utf8mb4_unicode_ci | — |
| `admin_users` | BASE TABLE | InnoDB | 2 | 16 KB | 48 KB | 4 | utf8mb4_unicode_ci | — |
| `archive_audit_logs` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | 1 | utf8mb4_unicode_ci | — |
| `automation_logs` | BASE TABLE | InnoDB | 607 | 144 KB | 192 KB | 619 | utf8mb4_unicode_ci | — |
| `balance_logs` | BASE TABLE | InnoDB | 601 | 96 KB | 80 KB | 602 | utf8mb4_unicode_ci | — |
| `content_articles` | BASE TABLE | InnoDB | 12 | 80 KB | 160 KB | 23 | utf8mb4_unicode_ci | — |
...
| `email_logs` | BASE TABLE | InnoDB | 241 | 208 KB | 112 KB | 310 | utf8mb4_unicode_ci | — |
| `failed_jobs` | BASE TABLE | InnoDB | 13 | 128 KB | 16 KB | 14 | utf8mb4_unicode_ci | — |
| `first_product_groups` | BASE TABLE | InnoDB | 6 | 16 KB | 96 KB | 7 | utf8mb4_unicode_ci | — |
| `gateway_logs` | BASE TABLE | InnoDB | 33 | 16 KB | 112 KB | 34 | utf8mb4_unicode_ci | — |
| `integration_plugin_bindings` | BASE TABLE | InnoDB | 11 | 16 KB | 80 KB | 12 | utf8mb4_unicode_ci | — |
| `integration_plugin_configs` | BASE TABLE | InnoDB | 4 | 16 KB | 16 KB | 6 | utf8mb4_unicode_ci | — |
| `integration_plugin_runtime_logs` | BASE TABLE | InnoDB | 41 | 64 KB | 80 KB | 58 | utf8mb4_unicode_ci | — |
| `integration_plugins` | BASE TABLE | InnoDB | 7 | 16 KB | 48 KB | 11 | utf8mb4_unicode_ci | — |
| `invoice_items` | BASE TABLE | InnoDB | 2,116 | 384 KB | 80 KB | 2,124 | utf8mb4_unicode_ci | 账单明细表，记录账单内每个收费项目和快照信息 |
| `invoices` | BASE TABLE | InnoDB | 2,142 | 1.52 MB | 1.08 MB | 2,150 | utf8mb4_unicode_ci | 账单主表，所有购买、续费、充值、扣款和退款流程以账单为财务入口 |
| `jobs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 68 | utf8mb4_unicode_ci | — |
| `media_files` | BASE TABLE | InnoDB | 18 | 16 KB | 48 KB | 23 | utf8mb4_unicode_ci | — |
| `member_levels` | BASE TABLE | InnoDB | 3 | 16 KB | 48 KB | 4 | utf8mb4_unicode_ci | — |
| `migrations` | BASE TABLE | InnoDB | 120 | 16 KB | 0 B | 129 | utf8mb4_unicode_ci | — |
| `notice_reads` | BASE TABLE | InnoDB | 30 | 16 KB | 48 KB | 42 | utf8mb4_unicode_ci | — |
| `notification_logs` | BASE TABLE | InnoDB | 610 | 10.5 MB | 720 KB | 1,430 | utf8mb4_unicode_ci | — |
| `operation_logs` | BASE TABLE | InnoDB | 119,699 | 51.58 MB | 27.09 MB | 123,384 | utf8mb4_unicode_ci | — |
| `orders` | BASE TABLE | InnoDB | 255 | 272 KB | 176 KB | 272 | utf8mb4_unicode_ci | — |
| `password_reset_tokens` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | — | utf8mb4_unicode_ci | — |
| `payment_callbacks` | BASE TABLE | InnoDB | 270 | 240 KB | 96 KB | 400 | utf8mb4_unicode_ci | 支付回调审计表，保存第三方通知、查询、退款等回调验签结果 |
| `payments` | BASE TABLE | InnoDB | 267 | 240 KB | 160 KB | 268 | utf8mb4_unicode_ci | 第三方支付记录表，仅记录真实外部资金流入和退款状态，不记录余额/免费/手工开服 |
| `personal_access_tokens` | BASE TABLE | InnoDB | 92 | 16 KB | 48 KB | 129 | utf8mb4_unicode_ci | — |
| `product_groups` | BASE TABLE | InnoDB | 37 | 16 KB | 80 KB | 45 | utf8mb4_unicode_ci | — |
| `product_upstream_bindings` | BASE TABLE | InnoDB | 138 | 8.52 MB | 96 KB | 144 | utf8mb4_unicode_ci | — |
| `products` | BASE TABLE | InnoDB | 139 | 8.52 MB | 144 KB | 150 | utf8mb4_unicode_ci | 商品表，记录可售卖产品的分类、定价、库存、上游绑定和开通策略 |
...
| `referral_withdrawals` | BASE TABLE | InnoDB | 0 | 16 KB | 48 KB | 1 | utf8mb4_unicode_ci | — |
| `roles` | BASE TABLE | InnoDB | 4 | 16 KB | 16 KB | 66 | utf8mb4_unicode_ci | — |
| `schedule_run_logs` | BASE TABLE | InnoDB | 66,493 | 13.52 MB | 10.06 MB | 66,559 | utf8mb4_unicode_ci | — |
| `second_product_groups` | BASE TABLE | InnoDB | 16 | 16 KB | 112 KB | 17 | utf8mb4_unicode_ci | — |
| `servers` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | 1 | utf8mb4_unicode_ci | — |
| `service_connection_snapshots` | BASE TABLE | InnoDB | 151 | 240 KB | 80 KB | 152 | utf8mb4_unicode_ci | — |
| `service_provision_attempts` | BASE TABLE | InnoDB | 199 | 96 KB | 80 KB | 399 | utf8mb4_unicode_ci | — |
| `service_runtime_snapshots` | BASE TABLE | InnoDB | 151 | 128 KB | 80 KB | 152 | utf8mb4_unicode_ci | — |
| `service_upstream_bindings` | BASE TABLE | InnoDB | 151 | 112 KB | 112 KB | 152 | utf8mb4_unicode_ci | — |
| `services` | BASE TABLE | InnoDB | 120 | 512 KB | 128 KB | 187 | utf8mb4_unicode_ci | 服务实例表，记录用户已购买产品的生命周期、计费、上游和续费状态 |
| `sessions` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | — | utf8mb4_unicode_ci | — |
| `settings` | BASE TABLE | InnoDB | 112 | 96 KB | 16 KB | 273 | utf8mb4_unicode_ci | — |
| `sms_logs` | BASE TABLE | InnoDB | 24 | 16 KB | 80 KB | 26 | utf8mb4_unicode_ci | — |
| `supplier_plugin_bindings` | BASE TABLE | InnoDB | 2 | 16 KB | 64 KB | 3 | utf8mb4_unicode_ci | — |
| `suppliers` | BASE TABLE | InnoDB | 2 | 16 KB | 32 KB | 3 | utf8mb4_unicode_ci | — |
| `third_product_groups` | BASE TABLE | InnoDB | 22 | 16 KB | 96 KB | 23 | utf8mb4_unicode_ci | — |
| `ticket_replies` | BASE TABLE | InnoDB | 136 | 16 KB | 16 KB | 137 | utf8mb4_unicode_ci | — |
| `tickets` | BASE TABLE | InnoDB | 49 | 16 KB | 80 KB | 50 | utf8mb4_unicode_ci | — |
| `user_accounts` | BASE TABLE | InnoDB | 410 | 64 KB | 0 B | — | utf8mb4_unicode_ci | 用户账户余额源表，集中承载现金余额、授信和推荐奖励余额 |
| `user_coupons` | BASE TABLE | InnoDB | 23 | 16 KB | 80 KB | 26 | utf8mb4_unicode_ci | — |
| `user_notifications` | BASE TABLE | InnoDB | 29 | 16 KB | 48 KB | 30 | utf8mb4_unicode_ci | — |
| `users` | BASE TABLE | InnoDB | 463 | 144 KB | 176 KB | 464 | utf8mb4_unicode_ci | — |
| `verification_histories` | BASE TABLE | InnoDB | 81 | 64 KB | 48 KB | 84 | utf8mb4_unicode_ci | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `account_transactions_created_at_idx` | 否 | `BTREE` | `created_at` | 605 | — |
| `account_transactions_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 618 | — |
| `account_transactions_trace_id_idx` | 否 | `BTREE` | `trace_id` | 542 | — |
| `account_transactions_user_account_created_idx` | 否 | `BTREE` | `user_id`, `account_type`, `created_at`, `id` | 619 | — |
| `account_transactions_user_event_created_idx` | 否 | `BTREE` | `user_id`, `event_type`, `created_at` | 612 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 619 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `automation_logs_object_idx` | 否 | `BTREE` | `object_type`, `object_id` | 305 | — |
| `automation_logs_task_key_index` | 否 | `BTREE` | `task_key` | 5 | — |
| `automation_logs_unique_rule` | 是 | `BTREE` | `task_key`, `action`, `object_type`, `object_id`, `rule_key` | 607 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 607 | — |
...
| `balance_logs_user_created_at_idx` | 否 | `BTREE` | `user_id`, `created_at` | 587 | — |
| `balance_logs_user_type_created_at_idx` | 否 | `BTREE` | `user_id`, `event_type`, `created_at` | 594 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 601 | — |
...
| `idx_article_category_published` | 否 | `BTREE` | `category_id`, `status`, `publish_at` | 12 | — |
| `idx_article_published` | 否 | `BTREE` | `status`, `publish_at`, `is_pinned` | 12 | — |
...
| 3 | `driver_key` | `varchar(120)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 4 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 5 | `template_code` | `varchar(20)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 6 | `to_email` | `varchar(255)` | 否 | — | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 7 | `subject` | `varchar(255)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 8 | `content` | `mediumtext` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 9 | `status` | `varchar(20)` | 否 | `pending` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 10 | `error_msg` | `text` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 11 | `sent_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `email_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 238 | — |
| `email_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 238 | — |
...
| `email_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 241 | — |
...
| --- | --- | --- | --- | --- | --- |
| `email_logs_plugin_fk` | `plugin_id` | `integration_plugins` | `id` | `NO ACTION` | `SET NULL` |
...
| `idx_first_group_code_visible` | 否 | `BTREE` | `code`, `is_visible` | 6 | — |
| `idx_first_group_visible` | 否 | `BTREE` | `is_visible` | 1 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `gateway_logs_created_at_index` | 否 | `BTREE` | `created_at` | 29 | — |
| `gateway_logs_gateway_action_index` | 否 | `BTREE` | `gateway`, `action` | 1 | — |
| `gateway_logs_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `created_at` | 33 | — |
| `gateway_logs_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 1 | — |
| `gateway_logs_out_trade_no_index` | 否 | `BTREE` | `out_trade_no` | 28 | — |
| `gateway_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 33 | — |
| `gateway_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 14 | — |
...
### 2.16 `integration_plugin_bindings`
...
| `plugin_bindings_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `domain` | 10 | — |
...
| `plugin_bindings_unique` | 是 | `BTREE` | `domain`, `binding_type`, `bindable_type`, `bindable_id`, `binding_key` | 11 | — |
...
### 2.17 `integration_plugin_configs`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `integration_plugin_configs_plugin_unique` | 是 | `BTREE` | `plugin_id` | 4 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 4 | — |
...
### 2.18 `integration_plugin_runtime_logs`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `plugin_runtime_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `created_at` | 12 | — |
| `plugin_runtime_domain_action_created_idx` | 否 | `BTREE` | `domain`, `action`, `created_at` | 12 | — |
| `plugin_runtime_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 12 | — |
| `plugin_runtime_status_created_idx` | 否 | `BTREE` | `status`, `created_at` | 12 | — |
| `plugin_runtime_trace_idx` | 否 | `BTREE` | `trace_id` | 41 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 41 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `integration_plugins_domain_key_unique` | 是 | `BTREE` | `domain`, `plugin_key` | 7 | — |
| `integration_plugins_domain_slug_unique` | 是 | `BTREE` | `domain`, `slug` | 7 | — |
| `integration_plugins_domain_status_index` | 否 | `BTREE` | `domain`, `status` | 7 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `invoice_items_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 2,116 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,116 | — |
...
| 10 | `user_coupon_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | 使用的用户优惠券ID |
...
| `invoices_invoice_no_unique` | 是 | `BTREE` | `invoice_no` | 2,141 | — |
| `invoices_order_id_idx` | 否 | `BTREE` | `order_id` | 258 | — |
| `invoices_product_id_idx` | 否 | `BTREE` | `product_id` | 49 | — |
| `invoices_service_id_idx` | 否 | `BTREE` | `service_id` | 128 | — |
| `invoices_status_due_date_index` | 否 | `BTREE` | `status`, `due_date` | 693 | — |
| `invoices_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 891 | — |
| `invoices_trace_id_idx` | 否 | `BTREE` | `trace_id` | 1,536 | — |
| `invoices_user_id_index` | 否 | `BTREE` | `user_id` | 309 | — |
| `invoices_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 2,071 | — |
| `invoices_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 2,141 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 2,142 | — |
...
| `notice_reads_user_id_article_id_unique` | 是 | `BTREE` | `user_id`, `article_id` | 30 | — |
| `notice_reads_user_id_index` | 否 | `BTREE` | `user_id` | 8 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 30 | — |

#### 外键约束

无数据库级外键约束。

### 2.27 `notification_logs`
...
| 3 | `driver_key` | `varchar(120)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 4 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 5 | `channel` | `varchar(20)` | 否 | — | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 6 | `recipient` | `varchar(191)` | 否 | — | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 7 | `template_code` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 8 | `subject` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 9 | `content` | `mediumtext` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 10 | `params_json` | `json` | 是 | `NULL` | — | — | — | — | — |
| 11 | `provider` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 12 | `request_id` | `varchar(100)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 13 | `status` | `varchar(20)` | 否 | `pending` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 14 | `error_msg` | `text` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 15 | `sent_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 16 | `origin_type` | `varchar(30)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 17 | `origin_id` | `bigint unsigned` | 是 | `NULL` | — | — | — | — | — |
| 18 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 19 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `notification_logs_channel_created_at_idx` | 否 | `BTREE` | `channel`, `created_at` | 575 | — |
| `notification_logs_channel_driver_idx` | 否 | `BTREE` | `channel`, `driver_key`, `created_at` | 610 | — |
| `notification_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 610 | — |
| `notification_logs_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 267 | — |
| `notification_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 610 | — |
| `notification_logs_recipient_created_at_idx` | 否 | `BTREE` | `recipient`, `created_at` | 575 | — |
| `notification_logs_request_id_idx` | 否 | `BTREE` | `request_id` | 12 | — |
| `notification_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 610 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 575 | — |

#### 外键约束

| 约束名 | 字段 | 引用表 | 引用字段 | 更新规则 | 删除规则 |
| --- | --- | --- | --- | --- | --- |
| `notification_logs_plugin_fk` | `plugin_id` | `integration_plugins` | `id` | `NO ACTION` | `SET NULL` |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `operation_logs_created_at_idx` | 否 | `BTREE` | `created_at` | 66,528 | — |
| `operation_logs_module_created_at_index` | 否 | `BTREE` | `module`, `created_at` | 100,030 | — |
| `operation_logs_module_subject_created_idx` | 否 | `BTREE` | `module`, `subject_id`, `created_at`, `id` | 106,332 | — |
| `operation_logs_user_created_at_idx` | 否 | `BTREE` | `user_id`, `created_at` | 73,008 | — |
| `operation_logs_user_id_user_type_index` | 否 | `BTREE` | `user_id`, `user_type` | 133 | — |
| `operation_logs_user_type_created_at_idx` | 否 | `BTREE` | `user_id`, `user_type`, `created_at` | 71,135 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 119,695 | — |
...
| `orders_created_at_idx` | 否 | `BTREE` | `created_at` | 244 | — |
| `orders_order_no_unique` | 是 | `BTREE` | `order_no` | 255 | — |
| `orders_product_id_idx` | 否 | `BTREE` | `product_id` | 47 | — |
| `orders_projection_type_idx` | 否 | `BTREE` | `projection_type` | 1 | — |
| `orders_service_status_id_idx` | 否 | `BTREE` | `service_id`, `status`, `id` | 255 | — |
| `orders_status_type_created_at_idx` | 否 | `BTREE` | `status`, `type`, `created_at`, `id` | 255 | — |
| `orders_trace_id_idx` | 否 | `BTREE` | `trace_id` | 120 | — |
| `orders_user_coupon_id_idx` | 否 | `BTREE` | `user_coupon_id` | 3 | — |
| `orders_user_id_index` | 否 | `BTREE` | `user_id` | 93 | — |
| `orders_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 255 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 255 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payment_callbacks_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `received_at` | 268 | — |
| `payment_callbacks_gateway_trade_no_idx` | 否 | `BTREE` | `gateway_trade_no` | 170 | — |
| `payment_callbacks_payment_type_unique` | 是 | `BTREE` | `payment_id`, `callback_type` | 266 | — |
| `payment_callbacks_plugin_received_idx` | 否 | `BTREE` | `plugin_id`, `received_at` | 268 | — |
| `payment_callbacks_trace_id_idx` | 否 | `BTREE` | `trace_id` | 73 | — |
| `payment_callbacks_verified_received_idx` | 否 | `BTREE` | `is_verified`, `received_at` | 265 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 266 | — |
...
| 10 | `status` | `tinyint` | 否 | `0` | MUL | — | — | — | 支付状态：0待支付 1成功 2失败 3已退款 |
| 11 | `callback_raw` | `json` | 是 | `NULL` | — | — | — | — | 最近一次回调原始载荷 JSON |
| 12 | `paid_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 第三方确认支付时间 |
| 13 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 创建时间 |
| 14 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 更新时间 |
| 15 | `remark` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 支付备注 |
| 16 | `operator` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 操作人快照 |
| 17 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 链路追踪号 |

#### 索引

| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payments_invoice_gateway_status_id_idx` | 否 | `BTREE` | `invoice_id`, `status`, `id` | 263 | — |
| `payments_invoice_status_created_at_idx` | 否 | `BTREE` | `invoice_id`, `status`, `created_at`, `id` | 263 | — |
| `payments_order_status_idx` | 否 | `BTREE` | `order_id`, `status` | 147 | — |
| `payments_payment_no_unique` | 是 | `BTREE` | `payment_no` | 263 | — |
| `payments_plugin_status_paid_idx` | 否 | `BTREE` | `plugin_id`, `status`, `paid_at` | 219 | — |
| `payments_plugin_trade_unique` | 是 | `BTREE` | `plugin_id`, `gateway_key`, `trade_no` | 172 | — |
| `payments_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 218 | — |
| `payments_trace_id_idx` | 否 | `BTREE` | `trace_id` | 73 | — |
| `payments_trade_no_index` | 否 | `BTREE` | `trade_no` | 170 | — |
| `payments_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 263 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 263 | — |
...
| `payments_plugin_fk` | `plugin_id` | `integration_plugins` | `id` | `NO ACTION` | `RESTRICT` |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `personal_access_tokens_expires_at_index` | 否 | `BTREE` | `expires_at` | 6 | — |
| `personal_access_tokens_token_unique` | 是 | `BTREE` | `token` | 91 | — |
| `personal_access_tokens_tokenable_type_tokenable_id_index` | 否 | `BTREE` | `tokenable_type`, `tokenable_id` | 29 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 91 | — |
...
### 2.35 `product_upstream_bindings`
...
| `product_upstream_product_status_idx` | 否 | `BTREE` | `product_id`, `status` | 138 | — |
| `product_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status` | 2 | — |
| `product_upstream_unique` | 是 | `BTREE` | `product_id`, `supplier_plugin_binding_id`, `upstream_product_id` | 138 | — |
...
| 15 | `status` | `tinyint` | 否 | `1` | MUL | — | — | — | 商品状态：0下架 1上架 |
| 16 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序值，越小越靠前 |
| 17 | `auto_setup` | `tinyint` | 否 | `0` | — | — | — | — | 是否自动开通：0手动 1自动 |
| 18 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 创建时间 |
| 19 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 更新时间 |
| 20 | `deleted_at` | `timestamp` | 是 | `NULL` | — | — | — | — | 软删除时间 |

#### 索引

| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_product_group_status` | 否 | `BTREE` | `second_product_group_id`, `third_product_group_id`, `status` | 27 | — |
| `idx_product_second_status` | 否 | `BTREE` | `second_product_group_id`, `status` | 18 | — |
| `idx_product_status_groups` | 否 | `BTREE` | `status`, `first_product_group_id`, `second_product_group_id` | 18 | — |
| `idx_product_third_status` | 否 | `BTREE` | `third_product_group_id`, `status` | 25 | — |
| `idx_products_product_groups` | 否 | `BTREE` | `first_product_group_id`, `second_product_group_id`, `third_product_group_id`, `status`, `sort_order` | 95 | — |
...
| 10 | `trace_id` | `varchar(64)` | 是 | `NULL` | UNI | — | utf8mb4 | utf8mb4_unicode_ci | — |
...
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 4 | — |
| `roles_name_unique` | 是 | `BTREE` | `name` | 4 | — |

#### 外键约束

无数据库级外键约束。

### 2.41 `schedule_run_logs`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 66,493 | — |
| `schedule_run_logs_created_at_index` | 否 | `BTREE` | `created_at` | 36,571 | — |
| `schedule_run_logs_status_index` | 否 | `BTREE` | `status` | 1 | — |
| `schedule_run_logs_task_name_created_at_index` | 否 | `BTREE` | `task_name`, `created_at` | 66,493 | — |
| `schedule_run_logs_task_name_index` | 否 | `BTREE` | `task_name` | 14 | — |

#### 外键约束

无数据库级外键约束。

### 2.42 `second_product_groups`
...
| 7 | `sort_order` | `int` | 否 | `0` | — | — | — | — | — |
| 8 | `is_visible` | `tinyint unsigned` | 否 | `1` | MUL | — | — | — | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_second_group_first_visible` | 否 | `BTREE` | `first_product_group_id`, `is_visible` | 6 | — |
| `idx_second_group_first_visible_sort` | 否 | `BTREE` | `first_product_group_id`, `is_visible`, `sort_order` | 15 | — |
| `idx_second_group_visible_sort` | 否 | `BTREE` | `is_visible`, `sort_order` | 14 | — |
| `idx_second_product_groups_first_sort` | 否 | `BTREE` | `first_product_group_id`, `sort_order` | 15 | — |
| `idx_second_product_groups_first_visible_sort` | 否 | `BTREE` | `first_product_group_id`, `is_visible`, `sort_order` | 15 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 16 | — |
| `second_product_groups_legacy_product_group_id_unique` | 是 | `BTREE` | `legacy_product_group_id` | 16 | — |
| `uniq_second_product_groups_first_slug` | 是 | `BTREE` | `first_product_group_id`, `slug` | 16 | — |
...
### 2.44 `service_connection_snapshots`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 151 | — |
| `service_connection_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 1 | — |
| `service_connection_plugin_checked_idx` | 否 | `BTREE` | `plugin_id`, `checked_at` | 151 | — |
| `service_connection_provider_type_idx` | 否 | `BTREE` | `provider_key`, `connection_type` | 1 | — |
| `service_connection_service_type_unique` | 是 | `BTREE` | `service_id`, `connection_type` | 151 | — |
| `service_connection_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 151 | — |
...
### 2.45 `service_provision_attempts`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 199 | — |
| `service_attempt_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 1 | — |
| `service_attempt_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `attempt_status`, `attempted_at` | 153 | — |
| `service_attempt_service_action_idx` | 否 | `BTREE` | `service_id`, `action`, `attempted_at` | 199 | — |
| `service_attempt_trace_idx` | 否 | `BTREE` | `trace_id` | 77 | — |
| `service_provision_attempts_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 151 | — |
...
### 2.46 `service_runtime_snapshots`
...
| `service_runtime_plugin_synced_idx` | 否 | `BTREE` | `plugin_id`, `synced_at` | 83 | — |
| `service_runtime_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_key` | 4 | — |
| `service_runtime_service_unique` | 是 | `BTREE` | `service_id` | 151 | — |
| `service_runtime_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 151 | — |
...
### 2.47 `service_upstream_bindings`
...
| `service_upstream_bindings_product_upstream_binding_id_foreign` | 否 | `BTREE` | `product_upstream_binding_id` | 44 | — |
| `service_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 2 | — |
| `service_upstream_plugin_sync_idx` | 否 | `BTREE` | `plugin_id`, `last_synced_at` | 83 | — |
| `service_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_snapshot` | 4 | — |
| `service_upstream_service_idx` | 否 | `BTREE` | `service_id` | 151 | — |
| `service_upstream_unique` | 是 | `BTREE` | `service_id`, `plugin_id`, `upstream_service_id` | 151 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 120 | — |
| `services_expires_at_index` | 否 | `BTREE` | `expires_at` | 120 | — |
| `services_invoice_id_idx` | 否 | `BTREE` | `invoice_id` | 39 | — |
| `services_order_id_idx` | 否 | `BTREE` | `order_id` | 120 | — |
| `services_product_id_idx` | 否 | `BTREE` | `product_id` | 44 | — |
| `services_status_expires_at_id_idx` | 否 | `BTREE` | `status`, `expires_at`, `id` | 120 | — |
| `services_trace_id_idx` | 否 | `BTREE` | `trace_id` | 66 | — |
| `services_user_id_index` | 否 | `BTREE` | `user_id` | 86 | — |
| `services_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 120 | — |
...
| 3 | `driver_key` | `varchar(120)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 4 | `trace_id` | `varchar(64)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 5 | `phone` | `varchar(20)` | 否 | — | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 6 | `template_code` | `varchar(50)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 7 | `params` | `json` | 是 | `NULL` | — | — | — | — | — |
| 8 | `content` | `varchar(500)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 9 | `status` | `varchar(20)` | 否 | `pending` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 10 | `provider` | `varchar(50)` | 否 | `aliyun` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 11 | `request_id` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 12 | `error_msg` | `text` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | — |
| 13 | `sent_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| `sms_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 24 | — |
| `sms_logs_phone_created_at_idx` | 否 | `BTREE` | `phone`, `created_at` | 24 | — |
| `sms_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 24 | — |
| `sms_logs_status_created_at_idx` | 否 | `BTREE` | `status`, `created_at` | 24 | — |
| `sms_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 24 | — |

#### 外键约束

| 约束名 | 字段 | 引用表 | 引用字段 | 更新规则 | 删除规则 |
| --- | --- | --- | --- | --- | --- |
| `sms_logs_plugin_fk` | `plugin_id` | `integration_plugins` | `id` | `NO ACTION` | `SET NULL` |

### 2.52 `supplier_plugin_bindings`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_third_group_second_visible_sort` | 否 | `BTREE` | `second_product_group_id`, `is_visible`, `sort_order` | 16 | — |
| `idx_third_group_visible_second` | 否 | `BTREE` | `is_visible`, `second_product_group_id` | 16 | — |
| `idx_third_product_groups_second_sort` | 否 | `BTREE` | `second_product_group_id`, `sort_order` | 15 | — |
| `idx_third_product_groups_second_visible_sort` | 否 | `BTREE` | `second_product_group_id`, `is_visible`, `sort_order` | 16 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 22 | — |
| `third_product_groups_legacy_product_group_id_unique` | 是 | `BTREE` | `legacy_product_group_id` | 22 | — |
| `uniq_third_product_groups_second_slug` | 是 | `BTREE` | `second_product_group_id`, `slug` | 22 | — |
...
| `ticket_replies_ticket_created_id_idx` | 否 | `BTREE` | `ticket_id`, `created_at`, `id` | 136 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 49 | — |
| `tickets_service_id_idx` | 否 | `BTREE` | `service_id` | 24 | — |
| `tickets_status_updated_at_idx` | 否 | `BTREE` | `status`, `updated_at` | 48 | — |
| `tickets_user_id_index` | 否 | `BTREE` | `user_id` | 20 | — |
| `tickets_user_status_updated_at_idx` | 否 | `BTREE` | `user_id`, `status`, `updated_at` | 49 | — |
| `tickets_user_updated_at_idx` | 否 | `BTREE` | `user_id`, `updated_at`, `id` | 49 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 23 | — |
| `user_coupons_coupon_status_idx` | 否 | `BTREE` | `coupon_id`, `status` | 4 | — |
| `user_coupons_coupon_user_unique` | 是 | `BTREE` | `coupon_id`, `user_id` | 23 | — |
| `user_coupons_uid_unique` | 是 | `BTREE` | `uid` | 23 | — |
| `user_coupons_user_status_idx` | 否 | `BTREE` | `user_id`, `status` | 21 | — |
| `user_coupons_user_status_uidx` | 否 | `BTREE` | `user_id`, `status` | 21 | — |
...
| `user_notifications_user_id_created_at_index` | 否 | `BTREE` | `user_id`, `created_at` | 29 | — |
| `user_notifications_user_id_read_at_index` | 否 | `BTREE` | `user_id`, `read_at` | 20 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 463 | — |
| `users_created_at_idx` | 否 | `BTREE` | `created_at` | 463 | — |
| `users_email_unique` | 是 | `BTREE` | `email` | 316 | — |
| `users_login_email_alert_index` | 否 | `BTREE` | `login_email_alert` | 2 | — |
| `users_member_level_id_index` | 否 | `BTREE` | `member_level_id` | 2 | — |
| `users_phone_unique` | 是 | `BTREE` | `phone` | 174 | — |
| `users_referral_code_unique` | 是 | `BTREE` | `referral_code` | 129 | — |
| `users_referrer_user_id_index` | 否 | `BTREE` | `referrer_user_id` | 5 | — |
| `users_status_id_idx` | 否 | `BTREE` | `status`, `id` | 463 | — |
| `users_verification_certify_id_idx` | 否 | `BTREE` | `verification_certify_id` | 99 | — |
| `users_verification_mix_idx` | 否 | `BTREE` | `is_verified`, `verification_status`, `id` | 463 | — |
| `users_verification_status_id_idx` | 否 | `BTREE` | `verification_status`, `id` | 463 | — |

#### 外键约束

无数据库级外键约束。

### 2.61 `verification_histories`
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 81 | — |
| `verification_histories_user_id_id_idx` | 否 | `BTREE` | `user_id`, `id` | 81 | — |
| `verification_histories_user_id_submitted_at_index` | 否 | `BTREE` | `user_id`, `submitted_at` | 81 | — |
| `verification_histories_verification_certify_id_index` | 否 | `BTREE` | `verification_certify_id` | 78 | — |
