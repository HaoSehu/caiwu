...
- 文档性质：参考资料 / 实库结构快照
- 生成时间：`2026-07-17 13:29:58 +08:00`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `account_transactions` | BASE TABLE | InnoDB | 675 | 160 KB | 224 KB | 1,741 | utf8mb4_unicode_ci | 账户流水表，记录现金账户、授信账户、推荐奖励账户的每一次余额变化 |
| `activity_logs` | BASE TABLE | InnoDB | 7,080 | 4.52 MB | 2.22 MB | 16,556 | utf8mb4_unicode_ci | — |
| `admin_user_roles` | BASE TABLE | InnoDB | 12 | 16 KB | 32 KB | 139 | utf8mb4_unicode_ci | — |
| `admin_users` | BASE TABLE | InnoDB | 274 | 80 KB | 48 KB | 313 | utf8mb4_unicode_ci | — |
| `agent_applications` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | 1 | utf8mb4_unicode_ci | — |
| `archive_audit_logs` | BASE TABLE | InnoDB | 0 | 16 KB | 32 KB | 1 | utf8mb4_unicode_ci | — |
| `automation_logs` | BASE TABLE | InnoDB | 1,029 | 224 KB | 336 KB | 1,049 | utf8mb4_unicode_ci | — |
...
| `coupons` | BASE TABLE | InnoDB | 76 | 16 KB | 48 KB | 85 | utf8mb4_unicode_ci | — |
| `failed_jobs` | BASE TABLE | InnoDB | 23 | 304 KB | 16 KB | 37 | utf8mb4_unicode_ci | — |
| `first_product_groups` | BASE TABLE | InnoDB | 7 | 16 KB | 32 KB | 8 | utf8mb4_unicode_ci | — |
| `gateway_logs` | BASE TABLE | InnoDB | 60 | 64 KB | 112 KB | 67 | utf8mb4_unicode_ci | — |
...
| `integration_plugin_runtime_logs` | BASE TABLE | InnoDB | 6,067 | 7.52 MB | 1.56 MB | 6,749 | utf8mb4_unicode_ci | — |
| `integration_plugins` | BASE TABLE | InnoDB | 0 | 16 KB | 48 KB | 1 | utf8mb4_unicode_ci | — |
| `invoice_items` | BASE TABLE | InnoDB | 2,776 | 512 KB | 96 KB | 2,770 | utf8mb4_unicode_ci | 账单明细表，记录账单内每个收费项目和快照信息 |
| `invoices` | BASE TABLE | InnoDB | 2,616 | 1.52 MB | 1.36 MB | 2,987 | utf8mb4_unicode_ci | 账单主表，所有购买、续费、充值、扣款和退款流程以账单为财务入口 |
| `jobs` | BASE TABLE | InnoDB | 0 | 16 KB | 16 KB | 879 | utf8mb4_unicode_ci | — |
...
| `message_logs` | BASE TABLE | InnoDB | 1,597 | 9.52 MB | 752 KB | 2,298 | utf8mb4_unicode_ci | — |
| `migrations` | BASE TABLE | InnoDB | 159 | 16 KB | 0 B | 163 | utf8mb4_unicode_ci | — |
| `notice_reads` | BASE TABLE | InnoDB | 99 | 16 KB | 48 KB | 132 | utf8mb4_unicode_ci | — |
| `notification_templates` | BASE TABLE | InnoDB | 56 | 256 KB | 32 KB | 981 | utf8mb4_unicode_ci | — |
| `operation_logs` | BASE TABLE | InnoDB | 135,943 | 62.59 MB | 30.09 MB | 148,248 | utf8mb4_unicode_ci | — |
| `orders` | BASE TABLE | InnoDB | 404 | 336 KB | 176 KB | 3,080 | utf8mb4_unicode_ci | — |
| `password_reset_tokens` | BASE TABLE | InnoDB | 0 | 16 KB | 0 B | — | utf8mb4_unicode_ci | — |
| `payment_callbacks` | BASE TABLE | InnoDB | 299 | 272 KB | 96 KB | 476 | utf8mb4_unicode_ci | 支付回调审计表，保存第三方通知、查询、退款等回调验签结果 |
| `payments` | BASE TABLE | InnoDB | 351 | 304 KB | 160 KB | 364 | utf8mb4_unicode_ci | 第三方支付记录表，仅记录真实外部资金流入和退款状态，不记录余额/免费/手工开服 |
| `personal_access_tokens` | BASE TABLE | InnoDB | 75 | 16 KB | 48 KB | 90 | utf8mb4_unicode_ci | — |
| `product_upstream_bindings` | BASE TABLE | InnoDB | 175 | 8.52 MB | 96 KB | 197 | utf8mb4_unicode_ci | — |
| `products` | BASE TABLE | InnoDB | 259 | 9.52 MB | 96 KB | 379 | utf8mb4_unicode_ci | 商品表，记录可售卖产品的分类、定价、库存、上游绑定和开通策略 |
| `referral_account_logs` | BASE TABLE | InnoDB | 6 | 16 KB | 64 KB | 7 | utf8mb4_unicode_ci | — |
| `referral_rewards` | BASE TABLE | InnoDB | 10 | 16 KB | 96 KB | 11 | utf8mb4_unicode_ci | — |
| `referral_withdrawals` | BASE TABLE | InnoDB | 3 | 16 KB | 48 KB | 4 | utf8mb4_unicode_ci | — |
| `roles` | BASE TABLE | InnoDB | 285 | 64 KB | 16 KB | 393 | utf8mb4_unicode_ci | — |
| `schedule_run_logs` | BASE TABLE | InnoDB | 149,056 | 30.56 MB | 21.06 MB | 148,518 | utf8mb4_unicode_ci | — |
| `schedule_task_runs` | BASE TABLE | InnoDB | 803 | 288 KB | 272 KB | 809 | utf8mb4_unicode_ci | — |
| `schedule_ticks` | BASE TABLE | InnoDB | 67 | 16 KB | 48 KB | 70 | utf8mb4_unicode_ci | — |
| `second_product_groups` | BASE TABLE | InnoDB | 16 | 16 KB | 32 KB | 17 | utf8mb4_unicode_ci | — |
| `service_connection_snapshots` | BASE TABLE | InnoDB | 176 | 272 KB | 80 KB | 193 | utf8mb4_unicode_ci | — |
| `service_provision_attempts` | BASE TABLE | InnoDB | 209 | 96 KB | 80 KB | 420 | utf8mb4_unicode_ci | — |
| `service_runtime_snapshots` | BASE TABLE | InnoDB | 176 | 208 KB | 80 KB | 193 | utf8mb4_unicode_ci | — |
| `service_upstream_bindings` | BASE TABLE | InnoDB | 180 | 144 KB | 112 KB | 197 | utf8mb4_unicode_ci | — |
| `services` | BASE TABLE | InnoDB | 176 | 1.52 MB | 128 KB | 300 | utf8mb4_unicode_ci | 服务实例表，记录用户已购买产品的生命周期、计费、上游和续费状态 |
...
| `supplier_plugin_bindings` | BASE TABLE | InnoDB | 76 | 48 KB | 64 KB | 84 | utf8mb4_unicode_ci | — |
| `suppliers` | BASE TABLE | InnoDB | 81 | 16 KB | 32 KB | 91 | utf8mb4_unicode_ci | — |
| `third_product_groups` | BASE TABLE | InnoDB | 24 | 16 KB | 32 KB | 25 | utf8mb4_unicode_ci | — |
| `ticket_replies` | BASE TABLE | InnoDB | 156 | 48 KB | 32 KB | 168 | utf8mb4_unicode_ci | — |
| `tickets` | BASE TABLE | InnoDB | 71 | 16 KB | 96 KB | 73 | utf8mb4_unicode_ci | — |
| `user_accounts` | BASE TABLE | InnoDB | 411 | 64 KB | 0 B | — | utf8mb4_unicode_ci | 用户账户余额源表，集中承载现金余额、授信和推荐奖励余额 |
| `user_coupons` | BASE TABLE | InnoDB | 78 | 16 KB | 64 KB | 90 | utf8mb4_unicode_ci | — |
| `user_notifications` | BASE TABLE | InnoDB | 89 | 48 KB | 48 KB | 96 | utf8mb4_unicode_ci | — |
| `users` | BASE TABLE | InnoDB | 774 | 208 KB | 256 KB | 988,048 | utf8mb4_unicode_ci | — |
| `verification_histories` | BASE TABLE | InnoDB | 86 | 64 KB | 48 KB | 96 | utf8mb4_unicode_ci | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `account_transactions_created_at_idx` | 否 | `BTREE` | `created_at` | 673 | — |
| `account_transactions_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 692 | — |
| `account_transactions_trace_id_idx` | 否 | `BTREE` | `trace_id` | 705 | — |
| `account_transactions_user_account_created_idx` | 否 | `BTREE` | `user_id`, `account_type`, `created_at`, `id` | 731 | — |
| `account_transactions_user_event_created_idx` | 否 | `BTREE` | `user_id`, `event_type`, `created_at` | 724 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 731 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `activity_logs_actor_id_index` | 否 | `BTREE` | `actor_id` | 375 | — |
| `activity_logs_created_at_index` | 否 | `BTREE` | `created_at` | 2,710 | — |
| `activity_logs_module_action_index` | 否 | `BTREE` | `module`, `action` | 920 | — |
| `activity_logs_subject_type_subject_id_index` | 否 | `BTREE` | `subject_type`, `subject_id` | 185 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 8,076 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `admin_user_roles_admin_role_unique` | 是 | `BTREE` | `admin_user_id`, `role_id` | 12 | — |
| `admin_user_roles_role_id_idx` | 否 | `BTREE` | `role_id` | 12 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `admin_users_email_index` | 否 | `BTREE` | `email` | 240 | — |
| `admin_users_role_id_index` | 否 | `BTREE` | `role_id` | 297 | — |
| `admin_users_username_unique` | 是 | `BTREE` | `username` | 305 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 305 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `automation_logs_object_idx` | 否 | `BTREE` | `object_type`, `object_id` | 365 | — |
| `automation_logs_task_key_index` | 否 | `BTREE` | `task_key` | 6 | — |
| `automation_logs_unique_rule` | 是 | `BTREE` | `task_key`, `action`, `object_type`, `object_id`, `rule_key` | 1,034 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 1,034 | — |
...
| `idx_stage2_coupon_campaigns_last_coupon_id` | 否 | `BTREE` | `last_coupon_id` | 8 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `coupons_campaign_status_idx` | 否 | `BTREE` | `coupon_campaign_id`, `status` | 11 | — |
| `coupons_code_unique` | 是 | `BTREE` | `code` | 79 | — |
| `coupons_status_sort_idx` | 否 | `BTREE` | `status`, `sort_order` | 2 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 79 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `failed_jobs_uuid_unique` | 是 | `BTREE` | `uuid` | 28 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `first_product_groups_code_unique` | 是 | `BTREE` | `code` | 7 | — |
| `first_product_groups_slug_unique` | 是 | `BTREE` | `slug` | 7 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `gateway_logs_created_at_index` | 否 | `BTREE` | `created_at` | 63 | — |
| `gateway_logs_gateway_action_index` | 否 | `BTREE` | `gateway`, `action` | 3 | — |
| `gateway_logs_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `created_at` | 66 | — |
| `gateway_logs_invoice_id_index` | 否 | `BTREE` | `invoice_id` | 1 | — |
| `gateway_logs_out_trade_no_index` | 否 | `BTREE` | `out_trade_no` | 62 | — |
| `gateway_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 66 | — |
| `gateway_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 13 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 66 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `plugin_bindings_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 0 | — |
| `plugin_bindings_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `domain` | 0 | — |
| `plugin_bindings_domain_provider_status_idx` | 否 | `BTREE` | `domain`, `provider_key`, `status` | 0 | — |
| `plugin_bindings_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 0 | — |
| `plugin_bindings_unique` | 是 | `BTREE` | `domain`, `binding_type`, `bindable_type`, `bindable_id`, `binding_key` | 0 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 0 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `plugin_runtime_bindable_idx` | 否 | `BTREE` | `bindable_type`, `bindable_id`, `created_at` | 3,565 | — |
| `plugin_runtime_domain_action_created_idx` | 否 | `BTREE` | `domain`, `action`, `created_at` | 4,488 | — |
| `plugin_runtime_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 3,805 | — |
| `plugin_runtime_status_created_idx` | 否 | `BTREE` | `status`, `created_at` | 3,589 | — |
| `plugin_runtime_trace_idx` | 否 | `BTREE` | `trace_id` | 6,352 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 6,352 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `integration_plugins_domain_key_unique` | 是 | `BTREE` | `domain`, `plugin_key` | 0 | — |
| `integration_plugins_domain_slug_unique` | 是 | `BTREE` | `domain`, `slug` | 0 | — |
| `integration_plugins_domain_status_index` | 否 | `BTREE` | `domain`, `status` | 0 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 0 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `fk_invoices_user_coupon_id` | 否 | `BTREE` | `user_coupon_id` | 20 | — |
| `idx_stage2_invoices_coupon_id` | 否 | `BTREE` | `coupon_id` | 23 | — |
| `invoices_invoice_no_unique` | 是 | `BTREE` | `invoice_no` | 2,954 | — |
| `invoices_order_id_idx` | 否 | `BTREE` | `order_id` | 370 | — |
| `invoices_product_id_idx` | 否 | `BTREE` | `product_id` | 92 | — |
| `invoices_service_id_idx` | 否 | `BTREE` | `service_id` | 146 | — |
| `invoices_status_due_date_index` | 否 | `BTREE` | `status`, `due_date` | 726 | — |
| `invoices_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 1,021 | — |
| `invoices_trace_id_idx` | 否 | `BTREE` | `trace_id` | 2,921 | — |
| `invoices_user_id_index` | 否 | `BTREE` | `user_id` | 460 | — |
| `invoices_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 2,794 | — |
| `invoices_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 2,954 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 3,174 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_member_level_sales_range` | 否 | `BTREE` | `sales_amount_min`, `sales_amount_max` | 4 | — |
| `idx_member_level_status_sort` | 否 | `BTREE` | `status`, `sort_order` | 2 | — |
| `member_levels_code_unique` | 是 | `BTREE` | `code` | 5 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `message_logs_channel_created_at_idx` | 否 | `BTREE` | `channel`, `created_at` | 727 | — |
| `message_logs_channel_driver_idx` | 否 | `BTREE` | `channel`, `driver_key`, `created_at` | 727 | — |
| `message_logs_driver_created_idx` | 否 | `BTREE` | `driver_key`, `created_at` | 727 | — |
| `message_logs_origin_idx` | 否 | `BTREE` | `origin_type`, `origin_id` | 269 | — |
| `message_logs_plugin_created_idx` | 否 | `BTREE` | `plugin_id`, `created_at` | 727 | — |
| `message_logs_recipient_created_at_idx` | 否 | `BTREE` | `recipient`, `created_at` | 727 | — |
| `message_logs_request_id_idx` | 否 | `BTREE` | `request_id` | 21 | — |
| `message_logs_trace_idx` | 否 | `BTREE` | `trace_id` | 727 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 726 | — |
...
| `notice_reads_user_id_article_id_unique` | 是 | `BTREE` | `user_id`, `article_id` | 99 | — |
| `notice_reads_user_id_index` | 否 | `BTREE` | `user_id` | 19 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 99 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `operation_logs_created_at_idx` | 否 | `BTREE` | `created_at` | 81,112 | — |
| `operation_logs_module_created_at_index` | 否 | `BTREE` | `module`, `created_at` | 102,968 | — |
| `operation_logs_module_subject_created_idx` | 否 | `BTREE` | `module`, `subject_id`, `created_at`, `id` | 143,206 | — |
| `operation_logs_user_created_at_idx` | 否 | `BTREE` | `user_id`, `created_at` | 85,593 | — |
| `operation_logs_user_id_user_type_index` | 否 | `BTREE` | `user_id`, `user_type` | 408 | — |
| `operation_logs_user_type_created_at_idx` | 否 | `BTREE` | `user_id`, `user_type`, `created_at` | 85,064 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 143,203 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `orders_coupon_id_idx` | 否 | `BTREE` | `coupon_id` | 13 | — |
| `orders_created_at_idx` | 否 | `BTREE` | `created_at` | 336 | — |
| `orders_order_no_unique` | 是 | `BTREE` | `order_no` | 395 | — |
| `orders_product_id_idx` | 否 | `BTREE` | `product_id` | 100 | — |
| `orders_projection_type_idx` | 否 | `BTREE` | `projection_type` | 1 | — |
| `orders_service_status_id_idx` | 否 | `BTREE` | `service_id`, `status`, `id` | 395 | — |
| `orders_status_type_created_at_idx` | 否 | `BTREE` | `status`, `type`, `created_at`, `id` | 395 | — |
| `orders_trace_id_idx` | 否 | `BTREE` | `trace_id` | 122 | — |
| `orders_user_coupon_id_idx` | 否 | `BTREE` | `user_coupon_id` | 13 | — |
| `orders_user_id_index` | 否 | `BTREE` | `user_id` | 218 | — |
| `orders_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 395 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 395 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payment_callbacks_gateway_key_idx` | 否 | `BTREE` | `gateway_key`, `received_at` | 306 | — |
| `payment_callbacks_gateway_trade_no_idx` | 否 | `BTREE` | `gateway_trade_no` | 210 | — |
| `payment_callbacks_payment_type_unique` | 是 | `BTREE` | `payment_id`, `callback_type` | 344 | — |
| `payment_callbacks_plugin_received_idx` | 否 | `BTREE` | `plugin_id`, `received_at` | 305 | — |
| `payment_callbacks_trace_id_idx` | 否 | `BTREE` | `trace_id` | 114 | — |
| `payment_callbacks_verified_received_idx` | 否 | `BTREE` | `is_verified`, `received_at` | 321 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 344 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `payments_invoice_gateway_status_id_idx` | 否 | `BTREE` | `invoice_id`, `status`, `id` | 361 | — |
| `payments_invoice_status_created_at_idx` | 否 | `BTREE` | `invoice_id`, `status`, `created_at`, `id` | 361 | — |
| `payments_order_status_idx` | 否 | `BTREE` | `order_id`, `status` | 192 | — |
| `payments_payment_no_unique` | 是 | `BTREE` | `payment_no` | 361 | — |
| `payments_plugin_status_paid_idx` | 否 | `BTREE` | `plugin_id`, `status`, `paid_at` | 275 | — |
| `payments_plugin_trade_unique` | 是 | `BTREE` | `plugin_id`, `gateway_key`, `trade_no` | 242 | — |
| `payments_status_paid_at_idx` | 否 | `BTREE` | `status`, `paid_at` | 273 | — |
| `payments_trace_id_idx` | 否 | `BTREE` | `trace_id` | 350 | — |
| `payments_trade_no_index` | 否 | `BTREE` | `trade_no` | 236 | — |
| `payments_user_status_created_idx` | 否 | `BTREE` | `user_id`, `status`, `created_at` | 357 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 361 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `personal_access_tokens_expires_at_index` | 否 | `BTREE` | `expires_at` | 2 | — |
| `personal_access_tokens_token_unique` | 是 | `BTREE` | `token` | 83 | — |
| `personal_access_tokens_tokenable_type_tokenable_id_index` | 否 | `BTREE` | `tokenable_type`, `tokenable_id` | 65 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 83 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 179 | — |
| `product_upstream_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `product_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 41 | — |
| `product_upstream_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 8 | — |
| `product_upstream_product_status_idx` | 否 | `BTREE` | `product_id`, `status` | 179 | — |
| `product_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status` | 4 | — |
| `product_upstream_unique` | 是 | `BTREE` | `product_id`, `supplier_plugin_binding_id`, `upstream_product_id` | 179 | — |
...
| `PRIMARY` | 是 | `BTREE` | `id` | 260 | — |
| `products_group_status_sort_id_idx` | 否 | `BTREE` | `product_group_id`, `status`, `sort_order`, `id` | 260 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_referral_reward_referred_status` | 否 | `BTREE` | `referred_user_id`, `status` | 6 | — |
| `idx_referral_reward_referrer_status` | 否 | `BTREE` | `referrer_user_id`, `status` | 5 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 9 | — |
| `referral_rewards_invoice_id_idx` | 否 | `BTREE` | `invoice_id` | 4 | — |
| `referral_rewards_order_id_unique` | 是 | `BTREE` | `order_id` | 9 | — |
| `referral_rewards_product_id_index` | 否 | `BTREE` | `product_id` | 5 | — |
| `referral_rewards_rewarded_at_index` | 否 | `BTREE` | `rewarded_at` | 8 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 299 | — |
| `roles_name_unique` | 是 | `BTREE` | `name` | 299 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 145,619 | — |
| `schedule_run_logs_created_at_index` | 否 | `BTREE` | `created_at` | 78,132 | — |
| `schedule_run_logs_status_index` | 否 | `BTREE` | `status` | 2 | — |
| `schedule_run_logs_task_name_created_at_index` | 否 | `BTREE` | `task_name`, `created_at` | 145,619 | — |
| `schedule_run_logs_task_name_index` | 否 | `BTREE` | `task_name` | 26 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 805 | — |
| `schedule_task_runs_source_created_at_index` | 否 | `BTREE` | `source`, `created_at` | 75 | — |
| `schedule_task_runs_status_created_at_index` | 否 | `BTREE` | `status`, `created_at` | 96 | — |
| `schedule_task_runs_task_key_created_at_index` | 否 | `BTREE` | `task_key`, `created_at` | 805 | — |
| `schedule_task_runs_tick_task_source_unique` | 是 | `BTREE` | `schedule_tick_id`, `task_key`, `source` | 805 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 67 | — |
| `schedule_ticks_daily_index_index` | 否 | `BTREE` | `daily_index` | 67 | — |
| `schedule_ticks_global_number_unique` | 是 | `BTREE` | `global_number` | 67 | — |
| `schedule_ticks_slot_started_at_unique` | 是 | `BTREE` | `slot_started_at` | 67 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_second_first_visible_sort` | 否 | `BTREE` | `first_product_group_id`, `is_visible`, `sort_order` | 15 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 175 | — |
| `service_connection_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `service_connection_plugin_checked_idx` | 否 | `BTREE` | `plugin_id`, `checked_at` | 115 | — |
| `service_connection_provider_type_idx` | 否 | `BTREE` | `provider_key`, `connection_type` | 2 | — |
| `service_connection_service_type_unique` | 是 | `BTREE` | `service_id`, `connection_type` | 175 | — |
| `service_connection_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 175 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 216 | — |
| `service_attempt_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `service_attempt_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `attempt_status`, `attempted_at` | 170 | — |
| `service_attempt_service_action_idx` | 否 | `BTREE` | `service_id`, `action`, `attempted_at` | 216 | — |
| `service_attempt_trace_idx` | 否 | `BTREE` | `trace_id` | 81 | — |
| `service_provision_attempts_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 157 | — |
...
| `service_runtime_plugin_synced_idx` | 否 | `BTREE` | `plugin_id`, `synced_at` | 111 | — |
| `service_runtime_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_key` | 8 | — |
| `service_runtime_service_unique` | 是 | `BTREE` | `service_id` | 175 | — |
| `service_runtime_snapshots_service_upstream_binding_id_foreign` | 否 | `BTREE` | `service_upstream_binding_id` | 175 | — |
...
| `service_upstream_bindings_product_upstream_binding_id_foreign` | 否 | `BTREE` | `product_upstream_binding_id` | 65 | — |
| `service_upstream_bindings_supplier_plugin_binding_id_foreign` | 否 | `BTREE` | `supplier_plugin_binding_id` | 24 | — |
| `service_upstream_plugin_sync_idx` | 否 | `BTREE` | `plugin_id`, `last_synced_at` | 111 | — |
| `service_upstream_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status_snapshot` | 8 | — |
| `service_upstream_service_idx` | 否 | `BTREE` | `service_id` | 177 | — |
| `service_upstream_unique` | 是 | `BTREE` | `service_id`, `plugin_id`, `upstream_service_id` | 177 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 190 | — |
| `services_expires_at_index` | 否 | `BTREE` | `expires_at` | 190 | — |
| `services_invoice_id_idx` | 否 | `BTREE` | `invoice_id` | 52 | — |
| `services_order_id_idx` | 否 | `BTREE` | `order_id` | 180 | — |
| `services_product_id_idx` | 否 | `BTREE` | `product_id` | 101 | — |
| `services_status_expires_at_id_idx` | 否 | `BTREE` | `status`, `expires_at`, `id` | 190 | — |
| `services_trace_id_idx` | 否 | `BTREE` | `trace_id` | 190 | — |
| `services_user_id_index` | 否 | `BTREE` | `user_id` | 144 | — |
| `services_user_status_id_idx` | 否 | `BTREE` | `user_id`, `status`, `id` | 190 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 111 | — |
| `settings_group_key_unique` | 是 | `BTREE` | `group_key`, `item_key` | 111 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 77 | — |
| `supplier_plugin_backfill_batch_idx` | 否 | `BTREE` | `backfill_batch_id` | 2 | — |
| `supplier_plugin_plugin_status_idx` | 否 | `BTREE` | `plugin_id`, `status` | 7 | — |
| `supplier_plugin_provider_status_idx` | 否 | `BTREE` | `provider_key`, `status` | 4 | — |
| `supplier_plugin_unique` | 是 | `BTREE` | `supplier_id`, `plugin_id`, `environment` | 77 | — |
...
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 83 | — |
| `suppliers_code_unique` | 是 | `BTREE` | `code` | 83 | — |
| `suppliers_status_sort_order_index` | 否 | `BTREE` | `status`, `sort_order` | 3 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_third_second_visible_sort` | 否 | `BTREE` | `second_product_group_id`, `is_visible`, `sort_order` | 17 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 24 | — |
| `uq_third_second_slug` | 是 | `BTREE` | `second_product_group_id`, `slug` | 24 | — |
...
| `PRIMARY` | 是 | `BTREE` | `id` | 167 | — |
| `ticket_replies_ticket_created_id_idx` | 否 | `BTREE` | `ticket_id`, `created_at`, `id` | 167 | — |
...
| `tickets_service_id_idx` | 否 | `BTREE` | `service_id` | 30 | — |
| `tickets_status_updated_at_idx` | 否 | `BTREE` | `status`, `updated_at` | 66 | — |
| `tickets_user_id_index` | 否 | `BTREE` | `user_id` | 34 | — |
| `tickets_user_status_updated_at_idx` | 否 | `BTREE` | `user_id`, `status`, `updated_at` | 72 | — |
| `tickets_user_updated_at_idx` | 否 | `BTREE` | `user_id`, `updated_at`, `id` | 72 | — |
...
| `user_coupons_coupon_status_idx` | 否 | `BTREE` | `coupon_id`, `status` | 60 | — |
| `user_coupons_coupon_user_unique` | 是 | `BTREE` | `coupon_id`, `user_id` | 81 | — |
| `user_coupons_uid_unique` | 是 | `BTREE` | `uid` | 81 | — |
| `user_coupons_user_status_idx` | 否 | `BTREE` | `user_id`, `status` | 73 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 95 | — |
| `user_notifications_type_index` | 否 | `BTREE` | `type` | 6 | — |
| `user_notifications_user_id_created_at_index` | 否 | `BTREE` | `user_id`, `created_at` | 94 | — |
| `user_notifications_user_id_read_at_index` | 否 | `BTREE` | `user_id`, `read_at` | 49 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 876 | — |
| `users_created_at_idx` | 否 | `BTREE` | `created_at` | 657 | — |
| `users_email_unique` | 是 | `BTREE` | `email` | 727 | — |
| `users_login_email_alert_index` | 否 | `BTREE` | `login_email_alert` | 2 | — |
| `users_member_level_id_index` | 否 | `BTREE` | `member_level_id` | 3 | — |
| `users_phone_unique` | 是 | `BTREE` | `phone` | 582 | — |
| `users_referral_code_unique` | 是 | `BTREE` | `referral_code` | 186 | — |
| `users_referrer_user_id_index` | 否 | `BTREE` | `referrer_user_id` | 10 | — |
| `users_status_id_idx` | 否 | `BTREE` | `status`, `id` | 876 | — |
| `users_verification_certify_id_idx` | 否 | `BTREE` | `verification_certify_id` | 116 | — |
| `users_verification_mix_idx` | 否 | `BTREE` | `is_verified`, `verification_status`, `id` | 876 | — |
| `users_verification_status_id_idx` | 否 | `BTREE` | `verification_status`, `id` | 876 | — |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 90 | — |
| `verification_histories_user_id_id_idx` | 否 | `BTREE` | `user_id`, `id` | 90 | — |
| `verification_histories_user_id_submitted_at_index` | 否 | `BTREE` | `user_id`, `submitted_at` | 90 | — |
| `verification_histories_verification_certify_id_index` | 否 | `BTREE` | `verification_certify_id` | 87 | — |
