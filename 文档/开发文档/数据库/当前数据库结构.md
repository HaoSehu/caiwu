...
- 文档性质：参考资料 / 实库结构快照
- 生成时间：`2026-07-08 14:52:27 +08:00`
...
| `first_product_groups` | VIEW | — | — | 0 B | 0 B | — | — | VIEW |
...
| `product_groups` | BASE TABLE | InnoDB | 51 | 16 KB | 96 KB | 52 | utf8mb4_unicode_ci | 商品分组自引用树，承载商品分类层级真源 |
...
| `second_product_groups` | VIEW | — | — | 0 B | 0 B | — | — | VIEW |
...
| `third_product_groups` | VIEW | — | — | 0 B | 0 B | — | — | VIEW |
...
| 序号 | 字段 | 类型 | 可空 | 默认值 | 键 | 额外 | 字符集 | 排序规则 | 注释 |
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | `0` | — | — | — | — | 商品分组ID |
| 2 | `code` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 顶级分组编码，沿用业务类型编码 |
| 3 | `name` | `varchar(100)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组名称 |
| 4 | `slug` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 同一上级下的URL标识 |
| 5 | `description` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组说明 |
| 6 | `icon` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组图标 |
| 7 | `banner_image` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组横幅图 |
| 8 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序值 |
| 9 | `is_visible` | `tinyint unsigned` | 否 | `1` | — | — | — | — | 是否前台可见：1=可见，0=隐藏 |
| 10 | `is_system` | `tinyint unsigned` | 否 | `0` | — | — | — | — | 是否系统内置：1=是，0=否 |
| 11 | `legacy_product_type` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 历史product_type值 |
| 12 | `product_type` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 业务商品类型 |
| 13 | `level` | `tinyint unsigned` | 否 | — | — | — | — | — | 层级：1=一级，2=二级，3=三级 |
...
- 自增值：`52`
- 排序规则：`utf8mb4_unicode_ci`
- 表注释：商品分组自引用树，承载商品分类层级真源

#### 字段

| 序号 | 字段 | 类型 | 可空 | 默认值 | 键 | 额外 | 字符集 | 排序规则 | 注释 |
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | — | PRI | auto_increment | — | — | 商品分组ID |
| 2 | `parent_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | 上级商品分组ID，顶级为NULL |
| 3 | `level` | `tinyint unsigned` | 否 | — | MUL | — | — | — | 层级：1=一级，2=二级，3=三级 |
| 4 | `code` | `varchar(50)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 顶级分组编码，沿用业务类型编码 |
| 5 | `product_type` | `varchar(50)` | 是 | `NULL` | MUL | — | utf8mb4 | utf8mb4_unicode_ci | 业务商品类型 |
| 6 | `name` | `varchar(100)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组名称 |
| 7 | `slug` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 同一上级下的URL标识 |
| 8 | `description` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组说明 |
| 9 | `icon` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组图标 |
| 10 | `banner_image` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组横幅图 |
| 11 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序值 |
| 12 | `is_visible` | `tinyint unsigned` | 否 | `1` | — | — | — | — | 是否前台可见：1=可见，0=隐藏 |
| 13 | `is_system` | `tinyint unsigned` | 否 | `0` | — | — | — | — | 是否系统内置：1=是，0=否 |
| 14 | `legacy_product_type` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 历史product_type值 |
| 15 | `legacy_product_group_id` | `bigint unsigned` | 是 | `NULL` | MUL | — | — | — | 历史product_groups ID映射 |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `PRIMARY` | 是 | `BTREE` | `id` | 51 | — |
| `product_groups_code_idx` | 否 | `BTREE` | `code` | 9 | — |
| `product_groups_legacy_group_idx` | 否 | `BTREE` | `legacy_product_group_id` | 38 | — |
| `product_groups_level_sort_idx` | 否 | `BTREE` | `level`, `sort_order` | 23 | — |
| `product_groups_parent_slug_unique` | 是 | `BTREE` | `parent_id`, `slug` | 51 | — |
| `product_groups_parent_visible_sort_idx` | 否 | `BTREE` | `parent_id`, `is_visible`, `sort_order` | 43 | — |
| `product_groups_product_type_idx` | 否 | `BTREE` | `product_type` | 8 | — |

#### 外键约束

| 约束名 | 字段 | 引用表 | 引用字段 | 更新规则 | 删除规则 |
| --- | --- | --- | --- | --- | --- |
| `product_groups_parent_fk` | `parent_id` | `product_groups` | `id` | `NO ACTION` | `RESTRICT` |
...
| 索引名 | 唯一 | 类型 | 字段 | 基数 | 注释 |
| --- | --- | --- | --- | ---: | --- |
| `idx_product_group_status` | 否 | `BTREE` | `status` | 28 | — |
| `idx_product_second_status` | 否 | `BTREE` | `status` | 19 | — |
| `idx_product_status_groups` | 否 | `BTREE` | `status` | 2 | — |
| `idx_product_third_status` | 否 | `BTREE` | `status` | 26 | — |
| `PRIMARY` | 是 | `BTREE` | `id` | 141 | — |
| `products_group_status_sort_id_idx` | 否 | `BTREE` | `product_group_id`, `status`, `sort_order`, `id` | 141 | — |
...
| 约束名 | 字段 | 引用表 | 引用字段 | 更新规则 | 删除规则 |
| --- | --- | --- | --- | --- | --- |
| `products_product_group_fk` | `product_group_id` | `product_groups` | `id` | `NO ACTION` | `RESTRICT` |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | `0` | — | — | — | — | 商品分组ID |
| 2 | `first_product_group_id` | `bigint unsigned` | 是 | `NULL` | — | — | — | — | 上级商品分组ID，顶级为NULL |
| 3 | `name` | `varchar(100)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组名称 |
| 4 | `slug` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 同一上级下的URL标识 |
| 5 | `description` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组说明 |
| 6 | `banner_image` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组横幅图 |
| 7 | `sort_order` | `int` | 否 | `0` | — | — | — | — | 排序值 |
| 8 | `is_visible` | `tinyint unsigned` | 否 | `1` | — | — | — | — | 是否前台可见：1=可见，0=隐藏 |
| 9 | `legacy_product_group_id` | `bigint unsigned` | 是 | `NULL` | — | — | — | — | 历史product_groups ID映射 |
| 10 | `product_type` | `varchar(50)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 业务商品类型 |
| 11 | `level` | `tinyint unsigned` | 否 | — | — | — | — | — | 层级：1=一级，2=二级，3=三级 |
| 12 | `created_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
| 13 | `updated_at` | `timestamp` | 是 | `NULL` | — | — | — | — | — |
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | 否 | `0` | — | — | — | — | 商品分组ID |
| 2 | `second_product_group_id` | `bigint unsigned` | 是 | `NULL` | — | — | — | — | 上级商品分组ID，顶级为NULL |
| 3 | `name` | `varchar(100)` | 否 | — | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组名称 |
| 4 | `slug` | `varchar(100)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 同一上级下的URL标识 |
| 5 | `description` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组说明 |
| 6 | `banner_image` | `varchar(255)` | 是 | `NULL` | — | — | utf8mb4 | utf8mb4_unicode_ci | 分组横幅图 |
