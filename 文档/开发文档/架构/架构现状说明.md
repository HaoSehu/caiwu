...
- `app/Integrations/Zjmf/`：仅保留旧密码兼容、账单恢复等非数据面兼容能力；ZJMF 财务数据面对接位于 `plugins/servers/zjmf_finance/`。
...
- 第三方和上游调用走插件目录、`Services/Integrations/Plugins`、`Services/Upstream`、`Integrations/Zjmf` 等专用层。
